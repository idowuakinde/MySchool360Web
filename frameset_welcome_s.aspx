<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frameset_welcome_s.aspx.vb" Inherits="frameset_welcome_s" Strict="false" %>
    ...
    <td valign="top"><table width="100%" border="0">
      <tr>
        <td align="center" valign="top" 
              bgcolor="<%= rowsSchoolTheme(0).Item("ExtensionField1") %>">
      ...
      <tr>
        <td align="center" valign="top">
          <table width="100%" border="0" bgcolor="#FFFFCC">
            <tr>
              <td align="center" 
                bgcolor="<%= rowsSchoolTheme(0).Item("ExtensionField1") %>"><span class="pageHeaderStyleAMMA"><font color="White">&nbsp;TOP 3 SECONDARY STUDENTS THIS TERM</font></span></td>
              </tr>
            <tr>
              <td align="center" valign="top" class="borderedTableGrey"><dotnet:Chart ID="chartTop5Secondary" runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="220px" ShadingEffectMode="Three" Width="650px">
          ...
          <table width="100%" border="0" bgcolor="#FFFFCC">
            <tr>
              <td align="center" 
                bgcolor="<%= rowsSchoolTheme(0).Item("ExtensionField1") %>"><span class="pageHeaderStyleAMMA"><font color="White">&nbsp;TOP 3 PRIMARY STUDENTS THIS TERM</font></span></td>
              </tr>
            <tr>
              <td align="center" valign="top" class="borderedTableGrey">
                  <dotnet:Chart ID="chartTop5Primary" runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="220px" ShadingEffectMode="Three" Width="650px">
                <DefaultTitleBox Visible="False">
                  <HeaderLabel GlowColor="" Type="UseFont"> </HeaderLabel>
                  <HeaderBackground ShadingEffectMode="None" />
          ...
          <table width="100%" border="0" bgcolor="#FFFFCC">
            <tr>
              <td align="center" 
                bgcolor="<%= rowsSchoolTheme(0).Item("ExtensionField1") %>"><span class="pageHeaderStyleAMMA"><font color="White">&nbsp;TOP 3 NURSERY PUPILS THIS TERM</font></span></td>
              </tr>
            <tr>
              <td align="center" valign="top" class="borderedTableGrey">
                  <dotnet:Chart ID="chartTop5Nursery" runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="220px" ShadingEffectMode="Three" Width="650px">
                <DefaultTitleBox Visible="False">
                  <HeaderLabel GlowColor="" Type="UseFont"> </HeaderLabel>
                  <HeaderBackground ShadingEffectMode="None" />
          ...
          <table width="100%" border="0" bgcolor="#FFFFCC">
            <tr>
              <td align="center" 
                bgcolor="<%= rowsSchoolTheme(0).Item("ExtensionField1") %>"><span class="pageHeaderStyleAMMA"><font color="White">&nbsp;TOP 3 CRECHE PUPILS THIS TERM</font></span></td>
              </tr>
            <tr>
              <td align="center" valign="top" class="borderedTableGrey">
                  <dotnet:Chart ID="chartTop5Creche" runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="220px" ShadingEffectMode="Three" Width="650px">
                <DefaultTitleBox Visible="False">
                  <HeaderLabel GlowColor="" Type="UseFont"> </HeaderLabel>
                  <HeaderBackground ShadingEffectMode="None" />
