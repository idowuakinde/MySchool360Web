<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_bulksms_message_history.aspx.vb" Inherits="modules_bulksms_rpt_bulksms_message_history" %>
                ...
                <tr>
                  <td width="80%">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text="REPORTS &gt; BULK SMS REPORTS &gt; MESSAGE HISTORY (GATEWAY #2)"></asp:Label>
                    <br />
                    <br />
