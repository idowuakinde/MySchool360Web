<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dashboard_acad4.aspx.vb" Inherits="modules_dashboards_dashboard_acad4" %>
...
<table width="1005"  border="0">
  <tr>
    <td width="999" valign="top"><span class="pageHeaderStyleAMMA">&nbsp;:: Academic Performance Dashboard (TERM-END, 2ND TERM)</span></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0">
      ...
      <tr>
        ...
        <td width="47%" class="defaultHeaderTextStyle">
            <asp:Label ID="Label2" runat="server" Font-Bold="True">TOP 5 SECONDARY STUDENTS (TERM-END, 2ND TERM)</asp:Label></td>
        <td width="3%" align="right" class="defaultHeaderTextStyle">3.</td>
        <td class="defaultHeaderTextStyle">
            <asp:Label ID="Label3" runat="server" Font-Bold="True">TOP 5 PRIMARY STUDENTS (TERM-END, 2ND TERM)</asp:Label></td>
      </tr>
      <tr>
        <td align="right" class="defaultHeaderTextStyle">&nbsp;</td>
      ...
      <tr>
        ...
        <td class="defaultHeaderTextStyle"><asp:Label ID="Label10" runat="server" Font-Bold="True">TOP 5 NURSERY PUPILS (TERM-END, 2ND TERM)</asp:Label></td>
        <td align="right" class="defaultHeaderTextStyle">5.</td>
        <td class="defaultHeaderTextStyle"><asp:Label ID="Label11" runat="server" Font-Bold="True">TOP 5 CRECHE PUPILS (TERM-END, 2ND TERM)</asp:Label></td>
      </tr>
      <tr>
        <td align="right" class="defaultHeaderTextStyle">&nbsp;</td>
      ...
      <tr>
          ...
          <td class="defaultHeaderTextStyle"><asp:Label ID="Label6" runat="server" Font-Bold="True">SUBJECT PASS RATES (TERM-END, 2ND TERM)</asp:Label></td>
          <td align="right" class="defaultHeaderTextStyle">&nbsp;</td>
          <td class="defaultHeaderTextStyle">&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
          ...
          <td class="defaultHeaderTextStyle"><asp:Label ID="Label7" runat="server" Font-Bold="True">CLASS PASS RATES (TERM-END, 2ND TERM)</asp:Label></td>
          <td align="right" class="defaultHeaderTextStyle"><span class="defaultHeaderTextStyle">8.</span></td>
          <td class="defaultHeaderTextStyle"><asp:Label ID="Label4" runat="server" Font-Bold="True">GENDER PASS RATES (TERM-END, 2ND TERM)</asp:Label></td>
      </tr>
      <tr>
