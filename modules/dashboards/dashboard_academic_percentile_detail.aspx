<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dashboard_academic_percentile_detail.aspx.vb" Inherits="modules_dashboards_dashboard_academic_percentile_detail" %>
...
<table width="1005"  border="0">
  <tr>
    <td width="999" valign="top"><span class="pageHeaderStyleAMMA">&nbsp;:: Class Percentiles (Mid-Term, 1st Term) for a Selected Class ('<%= classNames%>')</span></td>
  </tr>
  <tr>
