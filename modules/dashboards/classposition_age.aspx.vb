...
Partial Class modules_dashboards_classposition_age
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.lblClassName.Text &= "{" & studentClass & ", AGES}"
        ...
        Chart1.DefaultSeries.DefaultElement.ToolTip = "Portal Number: (Hidden), Age: %yvalue yrs"
        Chart1.Debug = True
        Chart1.Mentor = False
        ...
        de1.SqlStatement = "select right(CustomerCode,5) as MatricNumber, Cycle as Age from TEMPCustomers where DistrictCode = '" & studentClass & "' ORDER BY Age"
        Dim sc1 As SeriesCollection
        sc1 = de1.GetSeries()
        sc1(0).ImageBarTemplate = "../../images/ImageBars/black_pencil"

        Chart1.YAxis.ScaleRange.ValueLow = sc1(0).Elements(0).YValue - 0.3
        Chart1.YAxis.ScaleRange.ValueHigh = sc1(0).Elements(sc1(0).Elements.Count - 1).YValue + 0.3
        For Each el As Element In sc1(0).Elements
            ...
            If el.Name = matricNumber Then
                ...
                Dim a As New Annotation("This is you." & ControlChars.Lf & "Your Portal Number: %Name " & ControlChars.Lf & "Your Age: %YValue yrs" & ControlChars.Lf & "Your Position: " & (classSize - classPosition).ToString & "/" & classSize.ToString)
