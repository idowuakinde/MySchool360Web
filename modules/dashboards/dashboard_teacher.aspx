<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dashboard_teacher.aspx.vb" Inherits="modules_dashboards_dashboard_teacher" %>
...
<table width="1005"  border="0">
  <tr>
    <td width="999" valign="top"><span class="pageHeaderStyleAMMA">&nbsp;:: Teacher&#39;s Performance Monitors</span></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0">
      <tr>
        ...
        <td colspan="3" align="center" class="defaultHeaderTextStyle">
          <asp:Label ID="LabelA" runat="server" Font-Bold="True">AGGREGATE SCORES (ALL KPIs)</asp:Label></td>
        </tr>
            ...
            <tr>
              <td width="48%" align="center">&nbsp;
                <dotnet:Chart ID="Chart0" runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="300px" ShadingEffectMode="Three" Width="940px">
      ...
      <tr>
        ...
        <td class="defaultHeaderTextStyle"><asp:Label ID="Label10" runat="server" Font-Bold="True">TIME MANAGEMENT:</asp:Label></td>
        <td align="right" class="defaultHeaderTextStyle">2.</td>
        <td class="defaultHeaderTextStyle"><asp:Label ID="Label11" runat="server" Font-Bold="True">CONTROL OF STUDENTS' BEHAVIOUR:</asp:Label></td>
      </tr>
      <tr>
        <td align="right" class="defaultHeaderTextStyle">&nbsp;</td>
        ...
        <td class="defaultHeaderTextStyle borderedTable">&nbsp;
            <dotnet:Chart ID="Chart2" runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="220px" ShadingEffectMode="Three" Width="440px">
              <DefaultTitleBox Visible="False">
                <HeaderLabel GlowColor="" Type="UseFont"> </HeaderLabel>
                <HeaderBackground ShadingEffectMode="None" />
      ...
      <tr>
        <td align="right" class="defaultHeaderTextStyle">
            3.</td>
        <td class="defaultHeaderTextStyle"><asp:Label ID="Label12" runat="server" Font-Bold="True">PRESENTATION STYLE:</asp:Label></td>
        <td align="right" class="defaultHeaderTextStyle">
            4.</td>
        <td class="defaultHeaderTextStyle">
            <asp:Label ID="Label2" runat="server" Font-Bold="True">STUDENT PERFORMANCE MONITORING:</asp:Label></td>
      </tr>
      <tr>
        ...
        <td align="right" class="defaultHeaderTextStyle" style="height: 15px">&nbsp;</td>
        <td class="defaultHeaderTextStyle borderedTable" style="height: 15px">
            &nbsp;<dotnet:Chart ID="Chart4" runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="220px" ShadingEffectMode="Three" Width="440px">
                <DefaultTitleBox Visible="False">
                    <HeaderLabel GlowColor="" Type="UseFont">                    </HeaderLabel>
                    <HeaderBackground ShadingEffectMode="None" />
      ...
      <tr>
        ...
        <td class="defaultHeaderTextStyle"><asp:Label ID="lblScience" runat="server" Font-Bold="True">FEEDBACK DURING CLASSES:</asp:Label></td>
        <td align="right" class="defaultHeaderTextStyle">6.</td>
        <td class="defaultHeaderTextStyle"><asp:Label ID="lblHistory" runat="server" Font-Bold="True">ADAPTABILITY:</asp:Label></td>
      </tr>
      <tr>
        <td align="right" class="defaultHeaderTextStyle" style="height: 15px">&nbsp;</td>
        <td class="defaultHeaderTextStyle borderedTable" style="height: 15px"><dotnet:Chart ID="Chart5" runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="220px" ShadingEffectMode="Three" Width="440px">
            <DefaultTitleBox Visible="False">
              <HeaderLabel GlowColor="" Type="UseFont"> </HeaderLabel>
              <HeaderBackground ShadingEffectMode="None" />
      ...
      <tr>
        ...
        <td class="defaultHeaderTextStyle"><asp:Label ID="lblArt" runat="server" Font-Bold="True">COMMUNICATING OUTSIDE THE CLASSROOM:</asp:Label></td>
        <td align="right" class="defaultHeaderTextStyle">8.</td>
        <td class="defaultHeaderTextStyle"><asp:Label ID="lblRelEduc" runat="server" Font-Bold="True">PERFORMING NON-INSTRUCTIONAL DUTIES:</asp:Label></td>
      </tr>
      <tr>
        <td align="right" class="defaultHeaderTextStyle" style="height: 15px">&nbsp;</td>
