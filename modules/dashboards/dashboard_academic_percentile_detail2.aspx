<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dashboard_academic_percentile_detail2.aspx.vb" Inherits="modules_dashboards_dashboard_academic_percentile_detail2" %>
...
<table width="1005"  border="0">
  <tr>
    <td width="999" valign="top"><span class="pageHeaderStyleAMMA">&nbsp;:: Class Percentiles (Term-End, 1st Term) for a Selected Class ('<%= classNames%>')</span></td>
  </tr>
  <tr>
