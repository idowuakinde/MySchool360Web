...
Partial Class modules_dashboards_classposition_sports
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.lblClassName.Text &= "{" & studentClass & ", SPORTS}"
        ...
        de1.SqlStatement = "select right(CustomerCode,5) as MatricNumber, BelongToCode as Sports from TEMPCustomers where DistrictCode = '" & studentClass & "' ORDER BY Sports"
        Dim sc1 As SeriesCollection
        sc1 = de1.GetSeries()
        sc1(0).ImageBarTemplate = "../../images/ImageBars/black_pencil"

        Chart1.YAxis.ScaleRange.ValueLow = sc1(0).Elements(0).YValue - 3
        ...
        For Each el As Element In sc1(0).Elements
            ...
            If el.Name = matricNumber Then
                ...
                Dim a As New Annotation("This is you." & ControlChars.Lf & "Your Portal Number: %Name " & ControlChars.Lf & "Your Sports Score: %YValue%" & ControlChars.Lf & "Your Position: " & (classSize - classPosition).ToString & "/" & classSize.ToString)
