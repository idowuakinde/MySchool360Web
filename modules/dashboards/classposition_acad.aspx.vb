...
Partial Class modules_dashboards_school_classposition_acad
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.lblClassName.Text &= "{" & studentClass & ", ALL SUBJECTS}"
        ...
        'Chart1.DefaultSeries.DefaultElement.ToolTip = "Portal Number: %xvalue, Overall Average Score: %yvalue%"
        ...
        de1.SqlStatement = " SELECT PortalNumber, AVG(PersonalAggregateSubjectScore) AS AnnualAverage FROM [SmartSchoolDemo].[dbo].[VW_ACADEMICS_Student_Term_Totals] WHERE ClassName = '" & className & "' AND SessionName = '" & sessionName & "' GROUP BY PortalNumber ORDER BY AnnualAverage DESC "
        ...
        If sc1.Count > 0 Then
            ...
            For Each el As Element In sc1(0).Elements
                ...
                If el.Name = matricNumber Then
                    ...
                    classPosition = (sc1(0).Elements.Count - sc1(0).Elements.IndexOf(el)) - 1
                    'Dim a As New Annotation("This is you." & ControlChars.Lf & "Your Portal Number: %Name " & ControlChars.Lf & "Your Overall Score: %YValue%" & ControlChars.Lf & "Your Position: " & (classSize - classPosition).ToString & "/" & classSize.ToString)
                    Dim a As New Annotation("This is you." & ControlChars.Lf & "Your Portal Number: %Name " & ControlChars.Lf & "Your Overall Score: %YValue%")
                    If Common.ShowPosition Then a.Label.Text &= ControlChars.Lf & "Your Position: " & (classSize - classPosition).ToString & Common.GetOrdinal(classSize - classPosition).ToString & " of " & classSize.ToString
