...
Partial Class modules_dashboards_classposition_weight
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.lblClassName.Text &= "{" & studentClass & ", WEIGHTS}"
        ...
        Chart1.DefaultSeries.DefaultElement.ToolTip = "Portal Number: (Hidden), Weight: %yvalue kg"
        Chart1.Debug = True
        Chart1.Mentor = False
        ...
        de1.SqlStatement = "select right(CustomerCode,5) as MatricNumber, Occupancy as Weight from TEMPCustomers where DistrictCode = '" & studentClass & "' ORDER BY Weight"
        ...
        For Each el As Element In sc1(0).Elements
            ...
            If el.Name = matricNumber Then
                ...
                Dim a As New Annotation("This is you." & ControlChars.Lf & "Your Portal Number: %Name " & ControlChars.Lf & "Your Weight: %YValue kg" & ControlChars.Lf & "Your Position: " & (classSize - classPosition).ToString & "/" & classSize.ToString)
