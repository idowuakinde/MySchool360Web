<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_appraisals_admin.aspx.vb" Inherits="modules_hrm_hr_input_appraisals_admin" %>
                  ...
                  <tr>
                    <td style="margin-left: 200px">
                                ...
                                <asp:TemplateField HeaderText="DOMAIN GROUP A:">
                                    <InsertItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="dsSqlGetAppraisalDomainsByDepartmentAndGroup_A" 
                                            ...
                                            <SelectParameters>
                                                <asp:Parameter DefaultValue="Administrative" Name="AppraisalDepartment" />
                        ...
                        <asp:SqlDataSource ID="dsSqlGetSingleStaff" runat="server" 
                                            ConnectionString="<%$ ConnectionStrings:iTecon %>" 
                            SelectCommand="SELECT [StaffCode] AS StaffId, UPPER(Title) + ' ' + UPPER([Surname]) + ' ' + UPPER([OtherNames]) + ' (' + UPPER(b.[Remark1]) + ' Staff)' AS StaffDetails FROM [HR_Staff_Base] a INNER JOIN [Core_Department] b ON a.Department = b.DepartmentCode WHERE b.Remark1 = 'Administrative' ORDER BY Surname">
                        </asp:SqlDataSource>
