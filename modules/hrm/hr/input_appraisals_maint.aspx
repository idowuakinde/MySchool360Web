<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_appraisals_maint.aspx.vb" Inherits="modules_hrm_hr_input_appraisals_maint" %>
                    ...
                    <td style="margin-left: 200px">
                        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                            ...
                            <Fields>
                                ...
                                <asp:TemplateField HeaderText="PLEASE SELECT A STAFF:">
                                    <InsertItemTemplate>
                                            ...
                                            <tr valign="top">
                                                <td class="borderedTable">
                                                    ...
                                                    <asp:SqlDataSource ID="dsSqlMeetings" runat="server" 
                                                        ...
                                                        InsertCommand="STP_APPRAISAL_INSERT_HR_AppraisalDomainResponseHeaderMeeting" 
                                                        InsertCommandType="StoredProcedure" OnInserting="dsSqlMeetings_Inserting" 
                                                        OnSelecting="dsSqlMeetings_Selecting" OnInserted="dsSqlMeetings_Inserted" 
                                                        DeleteCommand="STP_APPRAISAL_DELETE_HR_AppraisalDomainResponseHeaderMeeting" 
                                                        DeleteCommandType="StoredProcedure">
                                                        <DeleteParameters>
                                                            <asp:Parameter Name="ResponseHeaderMeetingId" Type="Int32" />
                                                        </DeleteParameters>
                                                        <InsertParameters>
                                                            <asp:Parameter Direction="InputOutput" Name="ResponseHeaderMeetingId" Type="Int32" />
                                                            <asp:Parameter Name="HeaderId" Type="Int32" />
                                                            <asp:Parameter Name="MeetingDate" Type="DateTime" />
                                                            <asp:Parameter Name="MeetingObservation" Type="String" />
                                                    ...
                                                    <br />
                                                    <asp:DetailsView ID="dvMeetingObservation" runat="server" 
                                                        AutoGenerateRows="False" CellPadding="4" DataKeyNames="ResponseHeaderMeetingId" 
                                                        DataSourceID="dsSqlMeetings" DefaultMode="Insert" EnableModelValidation="True" 
                                                        ForeColor="#333333" GridLines="None" Width="600px" 
                                                        HeaderText="Add  a Meeting:" Visible="False">
                                                        <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                                                        ...
                                                        <PagerStyle BackColor="#FFCC66" ForeColor="#333333" HorizontalAlign="Center" />
                                                        <Fields>
                                                            <asp:BoundField DataField="ResponseHeaderId" HeaderText="ResponseHeaderId" 
                                                                InsertVisible="False" ReadOnly="True" SortExpression="ResponseHeaderId" />
                                                            <asp:TemplateField HeaderText="Meeting Date:" 
                                                                ...
                                                                <InsertItemTemplate>
                                                                    ...
                                                                    <asp:TextBox ID="txtCalendarAdd" runat="server" Columns="25" 
                                                                        ...
                                                                        Text='<%# Bind("MeetingDate") %>'></asp:TextBox>
                                                                    <a href="#" onclick="clientSideCalendarAdd.select(document.forms[0].DetailsView1_dvMeetingObservation_txtCalendarAdd,'anchorCalendarAdd','MM/dd/yyyy'); return false;" title="clientSideCalendarAdd.select(document.forms[0].DetailsView1_dvMeetingObservation_txtCalendarAdd,'anchorCalendarAdd','MM/dd/yyyy'); return false;" name="anchorCalendarAdd" id="anchorCalendarAdd">select</a>

                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                                        ControlToValidate="txtCalendarAdd" ErrorMessage="*" Font-Bold="True"></asp:RequiredFieldValidator>
                                                            ...
                                                            <asp:TemplateField HeaderText="Observation:" 
                                                                SortExpression="MeetingObservation">
                                                                <InsertItemTemplate>
                                                                    <asp:TextBox ID="txtObservation" runat="server" Columns="70" 
                                                                        CssClass="defaultFormElementStyle" Rows="5" TextMode="MultiLine" 
                                                                        Text='<%# Bind("MeetingObservation") %>'></asp:TextBox>
                                                                </InsertItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:CommandField ButtonType="Button" InsertText="Add New Meeting" 
                                ...
                                <asp:TemplateField HeaderText="DOMAIN GROUP A:">
                                    <InsertItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Rating">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="ddlRating" runat="server" 
                                                            CssClass="defaultFormElementStyle" DataSourceID="dsObjRatings">
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="dsSqlGetAppraisalDomainsByDepartmentAndGroup_A" 
                                            ...
                                            <SelectParameters>
                                                <asp:Parameter DefaultValue="Maintenance & Grounds" Name="AppraisalDepartment" />
                                        ...
                                        <table width="600px" border="0" class="borderedTable">
                                          <tr valign="top">
                                            <td class="pageHeaderStyle" width="60%">
                                                <strong>Teacher&#39;s Signature:</strong></td>
                        ...
                        <asp:SqlDataSource ID="dsSqlGetSingleStaff" runat="server" 
                                            ConnectionString="<%$ ConnectionStrings:iTecon %>" 
                            SelectCommand="SELECT [StaffCode] AS StaffId, UPPER(Title) + ' ' + UPPER([Surname]) + ' ' + UPPER([OtherNames]) + ' (' + UPPER(b.[Remark1]) + ' Staff)' AS StaffDetails FROM [HR_Staff_Base] a INNER JOIN [Core_Department] b ON a.Department = b.DepartmentCode WHERE b.Remark1 = 'Maintenance & Grounds' ORDER BY Surname">
                        </asp:SqlDataSource>
