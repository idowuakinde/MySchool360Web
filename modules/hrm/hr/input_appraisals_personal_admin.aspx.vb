...
Partial Class modules_hrm_hr_input_appraisals_personal_admin
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If rowsStaffDetails.Count > 0 Then
            ...
            Else
                ...
                Response.Redirect("input_appraisals_personal_maint.aspx?a=" & Request.QueryString("a") & "&b=" & Request.QueryString("b"), True)
            End If
        End If
