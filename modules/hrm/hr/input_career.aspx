<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_career.aspx.vb" Inherits="modules_hr_input_career" %>
        ...
        <table border="0" width="100%">
            ...
            <tr>
                <td colspan="2">
                        ...
                        Text=":: Update Previous Career Movements for the above Staff"></asp:Label></td>
            </tr>
            <tr>
                <td width="3%">&nbsp;
                    </td>
                <td>
                    <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True"
                        ...
                        DataKeyNames="StaffMovementId" AutoGenerateDeleteButton="True" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Career Movement Type" 
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Common.GetFullCareerMovementType(Databinder.Eval(Container.DataItem, "MovementType").ToString) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Former Designation" 
                            ...
                            <asp:TemplateField HeaderText="New Designation" 
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("NewDesignation") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Effective Date" SortExpression="EffectiveDate">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("EffectiveDate") %>' 
                                        Columns="30"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Common.GetFriendlyDate(CType(Databinder.Eval(Container.DataItem, "EffectiveDate"), Date)) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <asp:Label ID="lblAddNew" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text=":: Add a Career Movement for the above Staff"></asp:Label></td>
            </tr>
            <tr>
                <td>&nbsp;
                    </td>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False"
                        ...
                        AutoGenerateInsertButton="True" DataKeyNames="StaffMovementId" 
                        Visible="False">
                        <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="New Designation:" 
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("NewDesignationId") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Career Movement Type:" 
                                SortExpression="MovementType">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("MovementType") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Effective Date:" SortExpression="EffectiveDate">
                                <EditItemTemplate>
