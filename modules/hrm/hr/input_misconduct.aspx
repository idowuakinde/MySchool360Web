<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_misconduct.aspx.vb" Inherits="modules_hr_input_misconduct" %>
        ...
        <table border="0" width="100%">
            ...
            <tr>
                <td colspan="2">
                        ...
                        Text=":: Update Previous Misdemeanours for the above Staff"></asp:Label></td>
            </tr>
            <tr>
                <td width="3%">&nbsp;
                    </td>
                <td>
                    <asp:GridView ID="gvUsers" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        Visible="False" DataKeyNames="StaffMisconductId">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Brief Summary" SortExpression="BriefSummary">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("BriefSummary") %>' 
                            ...
                            <asp:TemplateField HeaderText="Detailed Description" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox5" runat="server" 
                                        Text='<%# Bind("DetailedDescription") %>' Columns="40" 
                            ...
                            <asp:TemplateField HeaderText="Date of Misdemeanour" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox4" runat="server" 
                                        Text='<%# Bind("DateOfMisdemeanour") %>' Columns="30"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Common.GetFriendlyDate(CType(Databinder.Eval(Container.DataItem,"DateOfMisdemeanour"), Date)) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Punishment Commencement Date" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" 
                                        Text='<%# Bind("PunishmentCommencementDate") %>' Columns="30"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Punishment Completion Date" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" 
                                        Text='<%# Bind("PunishmentCompletionDate") %>' Columns="30"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <asp:Label ID="lblAddNew" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text=":: Add a New Misdemeanour for the above Staff"></asp:Label></td>
            </tr>
            <tr>
                <td>&nbsp;
                    </td>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False"
                        ...
                        DataKeyNames="StaffMisconductId">
                        <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="Date of Misdemeanour:" 
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("DateOfMisdemeanour") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Prescribed Punishment:" 
                                SortExpression="PrescribedPunishment">
