...
Partial Class modules_hrm_hr_input_appraisals_maint_readonly
    Inherits System.Web.UI.Page

    Public selectedStaffCode As String, appraisalDepartment As String = "Maintenance & Grounds", serial As Int32 = 0, serialInner As Int32 = 0, headerId As Int32 = 0
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.lblHeader.Text = ":: Year " & Now.Year.ToString & " Employee Appraisal Form for MAINTENANCE & GROUNDS Staff (READ-ONLY)"
