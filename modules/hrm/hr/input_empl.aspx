<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_empl.aspx.vb" Inherits="modules_hr_input_empl" %>
        ...
        <table border="0" width="100%">
            ...
            <tr>
                <td colspan="2">
                        ...
                        Text=":: Update Previous Employments for the above Staff"></asp:Label></td>
            </tr>
            <tr>
                <td width="3%">&nbsp;
                    </td>
                <td>
                    <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True"
                        ...
                        DataKeyNames="StaffEmploymentId" AutoGenerateDeleteButton="True" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Start Date" SortExpression="StartDate">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Common.GetFriendlyDate(CType(DataBinder.Eval(Container.DataItem,"StartDate"), Date)) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="End Date" SortExpression="EndDate">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label5" runat="server" Text='<%# Common.GetFriendlyDate(CType(DataBinder.Eval(Container.DataItem, "EndDate"), Date)) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Duration">
                                <ItemTemplate>
                                    <asp:Label ID="Label11" runat="server" Text='<%# Common.GetTimespanInMonths(CType(Databinder.Eval(Container.DataItem, "StartDate"), Date), CType(Databinder.Eval(Container.DataItem, "EndDate"), Date)).ToString & " months" %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Last (Monthly) Salary" SortExpression="LastPay">
                                <EditItemTemplate>
                                    N
                                ...
                                <ItemTemplate>
                                    N
                                    <asp:Label ID="Label7" runat="server" Text='<%# FormatNumber(Databinder.Eval(Container.DataItem,"LastPay"), 2) %>'></asp:Label>
                                </ItemTemplate>
            ...
            <% 'If Me.gvUsers.Rows.Count <= 6 Then%>
            <tr>
                <td colspan="2">
                    <br />
                    <asp:Label ID="lblAddNew" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text=":: Add a Previous Employment for the above Staff"></asp:Label></td>
            </tr>
            <tr>
                <td>&nbsp;
                    </td>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False"
                        ...
                        AutoGenerateInsertButton="True" DataKeyNames="StaffEmploymentId" 
                        Visible="False">
                        <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="Name of Previous Employer:" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("EmployerName") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Address of Previous Employer:" 
                                SortExpression="EmployerAddress">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("EmployerAddress") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Reason For Exit:" SortExpression="ExitReason">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("ExitReason") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Last (Monthly) Pay Received:" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("LastPay") %>' CssClass="defaultFormElementStyleRightAligned"></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    N
                                    <asp:TextBox ID="TextBox6" runat="server" Columns="10" 
                                        Text='<%# Bind("LastPay") %>' CssClass="defaultFormElementStyleRightAligned"></asp:TextBox>
                                </InsertItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label7" runat="server" Text='<%# Bind("LastPay") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Contact Person &amp; Telephone:" 
                                SortExpression="Reference">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox8" runat="server" Text='<%# Bind("Reference") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
