<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_hospital.aspx.vb" Inherits="modules_hr_input_hospital" %>
        ...
        <table border="0" width="100%">
            ...
            <tr>
                <td colspan="2">
                        ...
                        Text=":: Update Previous Hospital Visits for the above Staff"></asp:Label></td>
            </tr>
            <tr>
                <td width="3%">&nbsp;
                    </td>
                <td>
                    <asp:GridView ID="gvUsers" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        Visible="False" DataKeyNames="StaffMedicalId">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Who Visited" SortExpression="WhoVisited">
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Brief Summary" SortExpression="BriefSummary">
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Doctors' Remark" SortExpression="DoctorsRemark">
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Date Admitted" SortExpression="DateAttended">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" Columns="30" 
                                        Text='<%# Bind("DateAttended") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Common.GetFriendlyDate(CType(Databinder.Eval(Container.DataItem, "DateAttended"), Date)) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Date Discharged" SortExpression="DateDischarged">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" Columns="30" 
                                        Text='<%# Bind("DateDischarged") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Common.GetFriendlyDate(CType(Databinder.Eval(Container.DataItem, "DateDischarged"), Date)) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Total Cost" SortExpression="MedicalExpenses">
                                <EditItemTemplate>
                                    N
                                ...
                                <ItemTemplate>
                                    N
                                    <asp:Label ID="Label1" runat="server" Text='<%# FormatNumber(Databinder.Eval(Container.DataItem, "MedicalExpenses"), 2) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <asp:Label ID="lblAddNew" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text=":: Add a New Hospital Visit for the above Staff"></asp:Label></td>
            </tr>
            <tr>
                <td>&nbsp;
                    </td>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False"
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="Which Hospital ?:" SortExpression="HospitalId">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("HospitalId") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Who Exactly Visited The Hospital?" 
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label8" runat="server" Text='<%# Bind("WhoVisited") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Brief Summary of Medical Incident:" 
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label7" runat="server" Text='<%# Bind("BriefSummary") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Detailed Description:" 
                                SortExpression="DetailedDescription">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label6" runat="server" Text='<%# Bind("DetailedDescription") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Doctor's (Additional) Remarks:" 
                                SortExpression="DoctorsRemark">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("DoctorsRemark") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="TextBox5" runat="server" Columns="50" 
                                        CssClass="defaultFormElementStyle" Rows="5" Text='<%# Bind("DoctorsRemark") %>' 
                                        TextMode="MultiLine"></asp:TextBox>
                                </InsertItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("DoctorsRemark") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Date Attended/Admitted:" 
                                SortExpression="DateAttended">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("DateAttended") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("DateAttended") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Date Discharged:" 
                                SortExpression="DateDischarged">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("DateDischarged") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("DateDischarged") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Total Cost Incurred:" 
                                SortExpression="MedicalExpenses">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("MedicalExpenses") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    N
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("MedicalExpenses") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
