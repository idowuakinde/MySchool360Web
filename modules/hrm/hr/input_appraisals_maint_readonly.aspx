<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_appraisals_maint_readonly.aspx.vb" Inherits="modules_hrm_hr_input_appraisals_maint_readonly" %>
                                        ...
                                        <table width="600px" border="0" class="borderedTable">
                                          <tr valign="top">
                                            <td class="pageHeaderStyle" width="60%">
                                                <strong>Staff Signature:</strong></td>
