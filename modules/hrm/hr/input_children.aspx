<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_children.aspx.vb" Inherits="modules_hr_input_children" %>
        ...
        <table border="0" width="100%">
            ...
            <tr>
                <td colspan="2">
                        ...
                        Text=":: Update Child Information for the above Staff"></asp:Label></td>
            </tr>
            <tr>
                <td width="3%">&nbsp;
                    </td>
                <td>
                    <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True"
                        ...
                        DataKeyNames="StaffChildId" Visible="False" 
                        AutoGenerateDeleteButton="True" AutoGenerateSelectButton="True">
                        <Columns>
                            <asp:BoundField DataField="StaffChildId" HeaderText="Id" 
                            ...
                            <asp:TemplateField HeaderText="Child Name" SortExpression="ChildName">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("ChildName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Gender" SortExpression="Gender">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Common.GetMaleOrFemale(DataBinder.Eval(Container.DataItem,"Gender").ToString) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Birthdate" SortExpression="Birthdate">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label5" runat="server" Text='<%# Common.GetFriendlyDate(CType(DataBinder.Eval(Container.DataItem,"BirthDate"), Date)) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Age">
                                <ItemTemplate>
                                    <asp:Label ID="Label8" runat="server" Text='<%# Common.GetTimespanInYears(CType(DataBinder.Eval(Container.DataItem,"BirthDate"), Date), now.Date).ToString & " yrs" %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <asp:Label ID="lblAddNew" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text=":: Add a New Child for the above Staff"></asp:Label></td>
            </tr>
            <tr>
                <td>&nbsp;
                    </td>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False"
                        ...
                        AutoGenerateInsertButton="True" DataKeyNames="StaffChildId" 
                        Visible="False">
                        <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="Name of Child:" SortExpression="ChildName">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("ChildName") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("ChildName") %>' 
                                        Columns="40"></asp:TextBox>
                                </InsertItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("ChildName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Telephone(s):" SortExpression="Telephone">
                                ...
                                <InsertItemTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("Telephone") %>' 
                                        Columns="40"></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Birthdate:" SortExpression="Birthdate">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("Birthdate") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
				...
				<asp:ListItem value="1911">1911</asp:ListItem>
                        ...
                        <asp:Label ID="lblBirthDate" runat="server" Text='<%# Bind("BirthDate") %>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Remark:" SortExpression="Remark">
                                ...
                                <InsertItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Remark") %>' 
