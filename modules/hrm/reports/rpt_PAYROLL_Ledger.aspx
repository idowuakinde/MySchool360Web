<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_PAYROLL_Ledger.aspx.vb" Inherits="modules_reports_rpt_PAYROLL_Ledger" %>
                ...
                <tr>
                  <td width="80%">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text="REPORTS > PAYROLL REPORTS > DETAILED PAYROLL LEDGER"></asp:Label>
                    <br />
