<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_HR_StaffListByDepartment.aspx.vb" Inherits="modules_reports_rpt_HR_StaffListByDepartment" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:SqlDataSource ID="dsSqlGetData" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                        SelectCommand="">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddlChooser" Name="Department" 
