<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_HR_StaffListByDesignation.aspx.vb" Inherits="modules_reports_rpt_HR_StaffListByDesignation" %>
                ...
                <tr>
                  <td width="80%">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text='REPORTS > HR REPORTS > STAFF LIST BY DESIGNATION: '></asp:Label>
                  <asp:DropDownList ID="ddlChooser" runat="server" AutoPostBack="True" 
                          CssClass="defaultFormElementStyle" AppendDataBoundItems="True" 
                          DataSourceID="dsSqlGetFilterData" DataTextField="DesignationName" 
                          DataValueField="DesignationName">
                      <asp:ListItem Value="0">ALL</asp:ListItem>
                  </asp:DropDownList>
                      <asp:SqlDataSource ID="dsSqlGetFilterData" runat="server" 
                          ConnectionString="<%$ ConnectionStrings:iTecon %>" 
                          SelectCommand="SELECT DISTINCT DesignationName FROM dbo.HR_Staff_Base a INNER JOIN dbo.HR_Designation b ON a.DesignationId = b.DesignationId ORDER BY DesignationName">
                      </asp:SqlDataSource>
                    <br />
                    <br />
            ...
            <tr>
                <td>
                    ...
                    <asp:SqlDataSource ID="dsSqlGetData" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                        SelectCommand="">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddlChooser" Name="DesignationName" 
