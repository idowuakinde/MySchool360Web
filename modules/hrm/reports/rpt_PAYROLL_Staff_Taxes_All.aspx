<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_PAYROLL_Staff_Taxes_All.aspx.vb" Inherits="modules_reports_rpt_PAYROLL_Staff_Taxes_All" %>
                ...
                <tr>
                  <td width="80%">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text="REPORTS > PAYROLL REPORTS > STAFF TAXES REPORT"></asp:Label>
                    <br />
                    <br />
            ...
            <tr>
                <td>
                    ...
                    <asp:SqlDataSource ID="dsSqlGetData" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                        ...
                        SelectCommand="SELECT a.PayrollArchiveId, a.StaffCode, a.StaffName, c.LocationName, d.JobLevelName, a.PAYE FROM	dbo.HR_PAYROLL_Archive_Shadow a INNER JOIN dbo.HR_Staff_Base b ON a.StaffId = b.StaffId INNER JOIN dbo.HR_Location c ON b.LocationId = c.LocationId INNER JOIN dbo.HR_JobLevel d ON b.JobLevelId = d.JobLevelId ORDER BY a.StaffName">
                    </asp:SqlDataSource>
                </td>
            </tr>
            <tr>
