<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_PAYROLL_Staff_UnionFOBTOB.aspx.vb" Inherits="modules_reports_rpt_PAYROLL_Staff_UnionFOBTOB" %>
                ...
                <tr>
                  <td width="80%">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text='REPORTS > PAYROLL REPORTS > STAFF DUES REPORT FOR: '></asp:Label>
                  <asp:DropDownList ID="ddlChooser" runat="server" AutoPostBack="True" 
                      CssClass="defaultFormElementStyle">
                      <asp:ListItem Value="ALL">FOBTOB + UNION</asp:ListItem>
                      <asp:ListItem>FOBTOB</asp:ListItem>
                        ...
                        <Columns>
                           ...
                           <asp:BoundField DataField="PayrollArchiveId" HeaderText="PayrollArchiveId"
                            ...
                            <asp:TemplateField HeaderText="Category" 
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("JobLevelName") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                ...
                                <FooterTemplate>
                                    TOTALS:
                                    <br />
                                    GRAND TOTAL (UNION + FOBTOB):
                                </FooterTemplate>
                                <FooterStyle Font-Size="Small" HorizontalAlign="Right" VerticalAlign="Top" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="FOBTOB" SortExpression="FOBTOB">
                                <FooterTemplate>
                                    ...
                                    <br />
                                    <span style="font-size:small">&#8358; <%=FormatNumber(total3, 2)%></span>
                                </FooterTemplate>
                                <ItemTemplate>
