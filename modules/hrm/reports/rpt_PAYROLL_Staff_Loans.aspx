<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_PAYROLL_Staff_Loans.aspx.vb" Inherits="modules_reports_rpt_PAYROLL_Staff_Loans" %>
                ...
                <tr>
                  <td width="80%">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text="REPORTS > PAYROLL REPORTS > STAFF LOANS REPORT"></asp:Label>
                    <br />
                    <br />
