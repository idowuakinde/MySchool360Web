...
Partial Class modules_reports_rpt_PAYROLL_Ledger
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        dsSqlGetData.SelectCommand = "SELECT a.PayrollArchiveId, b.staffid as StaffId, b.StaffCode as StaffCode, LTRIM(a.StaffName) as StaffName, [Basic], Functional, Overtime1, Overtime2, OtherTaxable, HousingTaxable as TaxableHousing, TransportTaxable as TaxableTransport, HousingNonTaxable as Housing, TransportNonTaxable as Transport, Lunch, Clothing, Utility, NiteShift as NightShift, PAYE, Loan, UnionDues, FOBTOB, COOP, OtherDeduction, Pension, (TotalTaxablePay + TotalNonTaxablePay) as grosspay, TotalDeduction as totalded, (TotalTaxablePay + TotalNonTaxablePay - TotalDeduction) as netpay FROM dbo.VW_HR_PAYROLL_Archive_Shadow a INNER JOIN dbo.HR_Staff_Base b ON a.StaffCode = b.StaffCode WHERE a.EffectiveMonth = " & activeMonth & " AND EffectiveYear = " & activeYear & " ORDER BY a.StaffName "
    End Sub
