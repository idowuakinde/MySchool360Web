<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_Prov_SpecialAllowances.aspx.vb" Inherits="modules_reports_rpt_Prov_SpecialAllowances" %>
                ...
                <tr>
                  <td width="80%">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text="REPORTS > PROVISIONAL PAYROLL REPORTS > SPECIAL ALLOWANCES REPORT"></asp:Label>
                    <br />
                    <br />
