<%@ Page Language="VB" AutoEventWireup="false" CodeFile="enrolment_new.aspx.vb" Inherits="modules_enrolment_enrolment_new" %>
...
<body topmargin="0" leftmargin="0">
    ...
    <div>
        <table width="880"  border="0" id="TABLE1">
            <tr>
                <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="225" align="left" valign="middle"><asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Small" Text=":: Record New Application"></asp:Label></td>
                ...
                <asp:TemplateField HeaderText="&nbsp;&nbsp;&nbsp;&gt;&nbsp;Session Applied For:">
                    <InsertItemTemplate>
                        <asp:Label ID="Label5b" runat="server" Font-Bold="True" 
                            Text='<%# sessionName & " Session" %>'></asp:Label>
                    </InsertItemTemplate>
                </asp:TemplateField>
        ...
        <asp:SqlDataSource ID="dsSqlAddStudent" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                    SelectCommand="STP_DATAENTRY_SELECTALL_Applicant"                     
                    InsertCommand="STP_DATAENTRY_INSERT_Applicant" 
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="BelongToCode" Type="String" />
            </InsertParameters>
        </asp:SqlDataSource>
