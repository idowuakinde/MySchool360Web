<%@ Page Language="VB" AutoEventWireup="false" CodeFile="managesyllabus_1.aspx.vb" Inherits="modules_academics_managesyllabus_1" %>
                                ...
                                <asp:TemplateField HeaderText="Term:" SortExpression="TermName">
                                    ...
                                    <InsertItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="dsSqlTermsAdd" runat="server" 
                                            ...
                                            SelectCommand="SELECT '1st Term' as TermName"></asp:SqlDataSource>
                                    </InsertItemTemplate>
                                </asp:TemplateField>
