<%@ Page Language="VB" AutoEventWireup="false" CodeFile="results_student_browse.aspx.vb" Inherits="modules_academics_results_student_browse" %>
...
<%  If profileOrientation = "Horizontal" Then%>
        <frameset rows="180,*" cols="*" frameborder="yes" border="1" framespacing="0">
            <frame src="result_student_all.aspx?a=5&b=1" name="allStudentsFrame" scrolling="auto" id="allStudentsFrame" title="allStudentsFrame" />
...
<%  ElseIf profileOrientation = "Vertical" Then%>
        <frameset cols="400,*" rows="*" frameborder="yes" border="1" framespacing="0">
            <frame src="result_student_all.aspx?a=19&b=1" name="allStudentsFrame" scrolling="auto" id="allStudentsFrame" title="allStudentsFrame" />
            <frame class="frameBottom" src="about:blank" name="singleStudentFrame" id="singleStudentFrame" title="singleStudentFrame" scrolling="auto" />
        </frameset>
<%  Else%>
