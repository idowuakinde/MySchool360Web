<%@ Page Language="VB" AutoEventWireup="false" CodeFile="managesyllabus.aspx.vb" Inherits="modules_system_setups_metadata_managesyllabus" %>
                                ...
                                <asp:TemplateField HeaderText="Term:" SortExpression="TermName">
                                    ...
                                    <InsertItemTemplate>
                                        <asp:DropDownList ID="DropDownList1" runat="server" 
                                            ...
                                            SelectedValue='<%# Bind("Remark") %>' DataSourceID="dsSqlTermsAdd" 
                                            DataTextField="TermName" DataValueField="TermName">
                                            <asp:ListItem></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:SqlDataSource ID="dsSqlTermsAdd" runat="server" 
                                            ConnectionString="<%$ ConnectionStrings:iTecon %>" 
                                            SelectCommand="SELECT '3rd Term' as TermName"></asp:SqlDataSource>
                                    </InsertItemTemplate>
                                </asp:TemplateField>
