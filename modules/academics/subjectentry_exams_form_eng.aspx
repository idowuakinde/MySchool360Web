<%@ Page Language="VB" AutoEventWireup="false" CodeFile="subjectentry_exams_form_eng.aspx.vb" Inherits="modules_academics_subjectentry_exams_form_eng" %>
...
<body topmargin="20" leftmargin="20">
    ...
    <div>
        <table width="100%"  border="0" id="TABLE1" onclick="return TABLE1_onclick()">
          <tr>
            <td colspan="2"><asp:Label CssClass="pageHeaderStyleAMMA" Font-Bold="True" Font-Size="Small" ID="Label10" runat="server" Text=":: Data Entry - Online Form - ENGLISH"></asp:Label></td>
          </tr>
          <tr>
            <td colspan="2">
