...
<%
	if request.Form("btnSubmit") <> "" then
		...
		Set theDoc = Nothing
		'post-success
		response.Write "<br><br><center><strong><font color='red'>Thank you! Invitation e-mails were <i>successfully</i> sent to the specified recipients.</font></strong></center><br>"
		'response.end
	end if
%>
...
<table width="1050" border="0" cellspacing="4" cellpadding="4">
  <tr>
    <td align="left" valign="top"><font class="pageHeaderStyle">Send Out The Students' Report Cards by E-mail</font>
    ...
    <td align="left" valign="top"><table width="100%"  border="0">
      <form action="" method="post" enctype="application/x-www-form-urlencoded" name="frmSendMails" id="frmSendMails">
        <tr>
          ...
          <td align="left" valign="top"><input readonly="readonly"  name="txtFrom" type="text" class="defaultFormElementStyle" id="txtFrom" value="Atlantic Hall" size="73" />
            &nbsp;</td>
        </tr>
        
        <tr>
          <td align="left" valign="top"><p class="defaultHeaderTextStyle"><strong>To: </strong></p>
              <p class="style5">Use commas (,) to separate <br />
                email addresses</p></td>
          <td>&nbsp;</td>
