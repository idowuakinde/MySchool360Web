...
<%
	...
	'rstDetail.Source = "SELECT * FROM dbo.TEMPScoreSheet_halfterm a INNER JOIN TEMPSubject c ON a.SubjectId = c.SubjectId WHERE a.MatricNumber = '" & matricNumber & "' AND a.Semester = " & term & ""
...
<%
	...
	rstAverage.Source = " SELECT AVG(ScoreCA1 + ScoreCA2) AS AverageScore FROM dbo.TEMPScoreSheet_halfterm a INNER JOIN dbo.TEMPSubject b ON a.SubjectId = b.SubjectId WHERE a.MatricNumber = '" & matricNumber & "' AND Semester = " & term & ""
