<%@ Page Language="VB" AutoEventWireup="false" CodeFile="summary_revenueheads.aspx.vb" Inherits="modules_reports_school_summary_revenueheads" %>
...
<head id="Head1" runat="server">
    <title>Revenue-Item Breakdown</title>
...
<table width="800"  border="0">
  <tr>
    <td width="999" valign="top"><span class="pageHeaderStyleAMMA">&nbsp;:: Payment-Purpose Analysis</span></td>
  </tr>
  <tr>
        ...
        <td align="left" valign="middle" style="width: 773px">
            <asp:GridView ID="gvUsers" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField FooterText="TOTAL:" HeaderText="REVENUE HEAD" SortExpression="RevenueHead">
                        <EditItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("RevenueHead") %>'></asp:Label>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="#" Text='<%# Eval("RevenueHead").ToString & " (" & FormatNumber(Eval("RevenueHeadCount").ToString,0) & " payments)" %>'></asp:HyperLink>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="False" />
            ...
            <asp:SqlDataSource ID="dsSqlRevenueHeadSummaries" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon_School %>"
                SelectCommand="select UPPER(TransactionType) as RevenueHead, sum(amount) as Revenue&#13;&#10;from dbo.TEMPOfficeEntries &#13;&#10;group by TransactionType&#13;&#10;order by sum(amount) desc">
            </asp:SqlDataSource>
        </td>
      </tr>
