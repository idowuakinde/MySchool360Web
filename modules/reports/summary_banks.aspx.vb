...
Partial Class modules_reports_school_summary_banks
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Chart.DefaultSeries.DefaultElement.ToolTip = "N %yvalue collected from %xvalue"
        Chart.Debug = True
        Chart.Mentor = False
    ...
    Protected Sub gvUsers_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvUsers.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            totalbranchCount += rowView("BranchCount").ToString
    ...
    Private Sub SetGridSource(ByVal filterExpression As String)
        Me.dsSqlBankSummaries.SelectCommand = "select UPPER(NewBankName) as Bank, count(distinct BankBranch) as BranchCount, sum(amount) as Revenue from dbo.TEMPOfficeEntries " & filterExpression & " group by NewBankName order by sum(amount) desc"
    End Sub
