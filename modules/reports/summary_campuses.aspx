<%@ Page Language="VB" AutoEventWireup="false" CodeFile="summary_campuses.aspx.vb" Inherits="modules_reports_school_summary_campuses" %>
...
<table width="800"  border="0">
  <tr>
    <td width="999" valign="top"><span class="pageHeaderStyleAMMA">&nbsp;:: Campus Analysis</span></td>
  </tr>
  <tr>
        ...
        <td align="left" valign="middle" style="width: 773px">
            <asp:GridView ID="gvUsers" runat="server" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="CAMPUS" SortExpression="CheckNo">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Campus") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='#' Text='<%# Eval("Campus").ToString & " (" & FormatNumber(Eval("CampusCount").ToString,0) & " students)" %>'></asp:HyperLink>
                        </ItemTemplate>
                        <HeaderStyle
                        ...
                        <FooterTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# FormatNumber(totalbranchCount,0).ToString & " students in all campuses" %>'></asp:Label>
                        </FooterTemplate>
