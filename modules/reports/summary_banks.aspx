<%@ Page Language="VB" AutoEventWireup="false" CodeFile="summary_banks.aspx.vb" Inherits="modules_reports_school_summary_banks" %>
...
<head id="Head1" runat="server">
    <title>Bank Trends Report</title>
...
<table width="800"  border="0">
  <tr>
    <td width="999" valign="top"><span class="pageHeaderStyleAMMA">&nbsp;:: Bank Analysis</span></td>
  </tr>
  <tr>
      ...
      <tr>
        ...
        <td align="left" valign="middle" style="width: 773px">
            <asp:GridView ID="gvUsers" runat="server" AllowSorting="True"
                ...
                DataSourceID="dsSqlBankSummaries" PageSize="30" Width="100%" ShowFooter="True" EnableViewState="False">
                <Columns>
                    <asp:TemplateField HeaderText="S/N" FooterText="TOTAL:">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="BANK" SortExpression="Bank">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Bank") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "summary_branches.aspx?a=" & Databinder.Eval(Container.DataItem, "Bank").ToString & "&b=" & filterDate_Start & "&c=" & filterDate_End %>' Text='<%# Eval("Bank").ToString & " (" & FormatNumber(Eval("BranchCount").ToString,0) & " branches)" %>'></asp:HyperLink>
                        </ItemTemplate>
                        <HeaderStyle
                        ...
                        <FooterTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# FormatNumber(totalbranchCount,0).ToString & " Bank Branches" %>'></asp:Label>
                        </FooterTemplate>
                        <FooterStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="AMOUNT" SortExpression="Revenue">
                        <EditItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Revenue", "N {0:N}") %>'></asp:Label>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# "N " & FormatNumber(total,2) %>'></asp:Label>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("Revenue", "N {0:N}") %>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle
                            HorizontalAlign="Right" VerticalAlign="Top" Wrap="False" />
            ...
            <asp:SqlDataSource ID="dsSqlBankSummaries" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon_School %>" SelectCommand="">
            </asp:SqlDataSource>
        </td>
      </tr>
      <tr>
        <td align="right" class="defaultHeaderTextStyle">&nbsp;</td>
        <td align="left" valign="middle" style="width: 773px">&nbsp;</td>
      </tr>
