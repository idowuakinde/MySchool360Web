<%@ Page Language="VB" AutoEventWireup="false" CodeFile="summary_geo_areas.aspx.vb" Inherits="modules_reports_school_summary_geo_areas" %>
...
<table width="800"  border="0">
  <tr>
    <td width="999" valign="top"><span class="pageHeaderStyleAMMA">&nbsp;:: Geographical-Area Analysis</span></td>
  </tr>
  <tr>
            ...
            <asp:GridView ID="gvUsers" runat="server" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="REGION" SortExpression="Region">
                        ...
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='#' Text='<%# Eval("Region").ToString & " (" & FormatNumber(Eval("RegionCount").ToString,0) & " students)" %>'></asp:HyperLink>
                        </ItemTemplate>
                        <HeaderStyle
                        ...
                        <FooterTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# FormatNumber(totalbranchCount,0).ToString & " students in all regions" %>'></asp:Label>
                        </FooterTemplate>
