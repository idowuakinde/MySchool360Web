<%@ Page Language="VB" AutoEventWireup="false" CodeFile="summary_businesstypes.aspx.vb" Inherits="modules_reports_school_summary_businesstypes" %>
...
<table width="800"  border="0">
  <tr>
    <td width="999" valign="top"><span class="pageHeaderStyleAMMA">&nbsp;:: Student-Level Analysis</span></td>
  </tr>
  <tr>
        ...
        <td align="left" valign="middle" style="width: 773px">
            <asp:GridView ID="gvUsers" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField FooterText="TOTAL:" HeaderText="CLASS" 
                        SortExpression="RevenueHead">
                        <EditItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("BusinessType") %>'></asp:Label>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="#" Text='<%# Eval("BusinessType").ToString & " (" & FormatNumber(Eval("BusinessTypeCount").ToString,0) & " payments)" %>'></asp:HyperLink>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" Wrap="False" />
            ...
            <asp:SqlDataSource ID="dsSqlRevenueHeadSummaries" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon_School %>"
                SelectCommand="select UPPER(ZoneCode) as BusinessType, sum(amount) as Revenue&#13;&#10;from dbo.TEMPOfficeEntries &#13;&#10;group by ZoneCode&#13;&#10;order by sum(amount) desc">
            </asp:SqlDataSource>
        </td>
      </tr>
