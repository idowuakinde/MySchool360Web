...
If Trim(strUsername) = "" OR isNull(strUsername) OR IsEmpty(strUsername) Then
	...
	Response.Write(vbCrLf & "alert('No username found!');")
	Response.Write(vbCrLf & "parent.location=""default.asp"";")
	Response.End
End If

If CheckIfBanned(getIP()) Then
	Response.Write(vbCrLf & "alert('Your IP has been banned!');")
	Response.Write(vbCrLf & "parent.location=""default.asp"";")
	Response.End
End If
...
If blnUserFound = False Then
	...
	Call PostMessage("", saryActiveUsers(1, intArrayPass) & " has joined the room.", 1)
End If
...
Select Case strAdminCommand
	Case "kick"
		...
		Response.Write(vbCrLf & "alert('You have been kicked!');")
		Response.Write(vbCrLf & "parent.location=""default.asp"";")
		Response.End
End Select
