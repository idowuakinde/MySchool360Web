...
<html>
<head>
<title>Chatroom - Logged in as <% = strUsername %></title>
...
<body bgcolor="#6E6E6E" style="margin: 0px;">
...
<table width="700" height="460" cellpadding="5" cellspacing="0" align="center" style="border: 0px solid #393939;">
 <tr>
  <td bgcolor="#D1E0F8" rowspan="4">&nbsp;</td>
  <td bgcolor="#D1E0F8" width="70%" class="chatBorderText">ASP ChatNow Beta (type <i>/commands</i> in message box for commands)</td>
  <td bgcolor="#D1E0F8" rowspan="3" width="1"></td>
  <td bgcolor="#D1E0F8" width="150" class="chatBorderText">Users Online</td>
  <td bgcolor="#D1E0F8" rowspan="4">&nbsp;</td>
 </tr>
 <tr>
 ...
 <tr>
  <td bgcolor="#D1E0F8" colspan="5" align="right">
  <table cellpadding="0" cellspacing="0" width="100%">
   <tr>
    <td align="left" class="copyright">Copyright © 2001-2004 <a href="http://www.aspchatnow.com" target="_blank" class="copyright">ASP ChatNow</a>. All rights reserved.</td>
    <td><input type='checkbox' name='turnoffsound' value='True' checked onClick='chatframe.SoundOption()'> Turn Sound On</td>
    <td align="right" class="LogOut"><a href="javascript:logOut()" title="Logout">Logout</a></td>
   </tr>
  </table>
  </td>
 </tr>
