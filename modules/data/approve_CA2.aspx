<%@ Page Language="VB" AutoEventWireup="false" CodeFile="approve_CA2.aspx.vb" Inherits="modules_data_approve_CA2" %>
...
&nbsp;&nbsp;<asp:Button ID="btnEmailBatch" runat="server" 
        ...
        <asp:GridView ID="gvMaster" runat="server" CssClass="noBorderedMenuTable" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Cycle Test" SortExpression="Score">
                    <ItemTemplate>
                        <asp:Label ID="Label6" runat="server" Font-Bold="True" 
                            Text='<%# CType(Databinder.Eval(Container.DataItem, "Score"), Int32) %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                ...
                <asp:TemplateField HeaderText="Class Test" SortExpression="ScoreClassTest">
                    <ItemTemplate>
                        <asp:Label ID="Label7" runat="server" Font-Bold="True" 
                            Text='<%# CType(Databinder.Eval(Container.DataItem, "ScoreClassTest"), Int32) %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Assignments" SortExpression="ScoreAssignments">
                    <ItemTemplate>
                        <asp:Label ID="Label8" runat="server" Font-Bold="True" 
                            Text='<%# CType(Databinder.Eval(Container.DataItem, "ScoreAssignments"), Int32) %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Class Work" SortExpression="ScoreClassWork">
                    <ItemTemplate>
                        <asp:Label ID="Label9" runat="server" Font-Bold="True" 
                            Text='<%# CType(Databinder.Eval(Container.DataItem, "ScoreClassWork"), Int32) %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
