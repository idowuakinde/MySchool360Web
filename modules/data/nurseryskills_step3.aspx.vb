...
Partial Class modules_data_nurseryskills_step3
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Select Case rowView("ClassName").ToString.ToUpper
                Case "NURSERY 1", "NURSERY 2", "NURSERY 1 BLUE", "NURSERY 1 RED", "NURSERY 2 BLUE", "NURSERY 2 RED", "PLAYGROUP"    'nursery & playgroup
                    ...
                    CType(e.Row.FindControl("hlnkEnterSkillsReport"), HyperLink).NavigateUrl = "manage_student_scores_nurseryskills_CA6.aspx?a=" & rowView("PortalNumber").ToString
                ...
                Case "YEAR 1", "YEAR 2", "YEAR 3", "YEAR 1 BLUE", "YEAR 1 RED", "YEAR 2 BLUE", "YEAR 2 RED", "YEAR 3 BLUE", "YEAR 3 RED", "YEAR 4 BLUE", "YEAR 4 RED", "YEAR 5 BLUE", "YEAR 5 RED", "YEAR 6"     'primary
                    ...
                    CType(e.Row.FindControl("hlnkEnterSkillsReport"), HyperLink).NavigateUrl = "manage_student_scores_primaryskills_CA6.aspx?a=" & rowView("PortalNumber").ToString
