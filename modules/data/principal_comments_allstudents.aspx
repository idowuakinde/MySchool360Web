<%@ Page Language="VB" AutoEventWireup="false" CodeFile="principal_comments_allstudents.aspx.vb" Inherits="modules_data_principal_comments_selector" %>
    ...
    <form id="form1" runat="server">
        <table width="100%"  border="0" id="TABLE1">
            <tr>
                <td width="5">&nbsp;</td>
                <td>
                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Text="Please select a student from the list below to comment on their results."></asp:Label>
                </td>
            </tr>
            <tr>
                <td></td>
