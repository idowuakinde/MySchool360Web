<%@ Page Language="VB" AutoEventWireup="false" CodeFile="manage_student_scores_CA5.aspx.vb" Inherits="modules_data_manage_student_scores_CA5" %>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:ObjectDataSource ID="dsObjScores" runat="server" 
                            ...
                            <SelectParameters>
                                ...
                                <asp:Parameter DefaultValue="40" Name="maximum" Type="Double" />
