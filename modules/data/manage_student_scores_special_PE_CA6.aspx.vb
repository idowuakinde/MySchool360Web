...
Partial Class modules_data_manage_student_scores_special_PE_CA6
    ...
    Protected Sub btnSaveScores_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveScores.Click
        ...
        For i As Int32 = 0 To Me.gvMaster.Rows.Count - 1
            ...
            sqlInsert &= "ELSE "
            sqlInsert &= "      INSERT INTO dbo.TEMPStudentSubjectScore2(PortalNumber, SubjectShortName, SessionName, TermName, AssessmentType, Score, ScoreClassTest, Comment) "
