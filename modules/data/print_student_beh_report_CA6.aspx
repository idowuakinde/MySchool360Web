<%@ Page Language="VB" AutoEventWireup="false" CodeFile="print_student_beh_report_CA6.aspx.vb" Inherits="modules_data_print_student_beh_report_CA6" %>
                        ...
                        Text=":: BEHAVIOURAL ASSESSMENT REPORT"></asp:Label>
                            ...
                            <td align="right" valign="top">
                                <input name="btnPrint" type="button" class="defaultButtonStyle" id="btnPrint" 
                                    ...
                                    onclick="javascript:document.getElementById('btnPrint').style.display = 'none';GenerateDynamicPDF('print_student_beh_report_CA6_pdf.aspx?a=<%= portalNumber %>&c=<%= sessionName %>');" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
