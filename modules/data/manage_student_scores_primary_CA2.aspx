<%@ Page Language="VB" AutoEventWireup="false" CodeFile="manage_student_scores_primary_CA2.aspx.vb" Inherits="modules_data_manage_student_scores_primary_CA2" %>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="C.A." SortExpression="Score">
                    <ItemTemplate>
                        ...
                        <br />
                        <asp:DropDownList ID="ddlCA" runat="server" AppendDataBoundItems="True" CssClass="defaultFormElementStyle" DataSourceID="dsObjScores" SelectedValue='<%# CType(Databinder.Eval(Container.DataItem, "Score"), Int32) %>'>
                ...
                <asp:TemplateField HeaderText="Exam" SortExpression="ScoreClassTest">
                    <ItemTemplate>
                        ...
                        <br />
                        <asp:DropDownList ID="ddlCycleTest" runat="server" AppendDataBoundItems="True" 
