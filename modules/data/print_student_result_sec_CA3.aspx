<%@ Page Language="VB" AutoEventWireup="false" CodeFile="print_student_result_sec_CA3.aspx.vb" Inherits="modules_data_print_student_result_sec_CA3" %>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr class="pageHeaderStyle">
                                            <td align="right" colspan="4">
                                                <input name="btnPrint" type="button" class="defaultButtonStyle" id="btnPrint" value="   Print This Page   " onclick="javascript:document.getElementById('btnPrint').style.display = 'none';GenerateDynamicPDF('print_student_result_sec_CA3_pdf.aspx?a=<%= portalNumber %>&c=<%= sessionName %>');" />
                                            </td>
                                        </tr>
                                        <tr class="pageHeaderStyle">
                                        ...
                                        <tr>
                                            <td align="center" valign="top" class="pageHeaderStyle">
                                                ...
                                                <asp:Label ID="Label6" runat="server" 
                                                    ...
                                                    Text='<%# FormatNumber(Common.GetStudentsPersonalAverage(portalNumber, className, sessionName, TermName, assessmentType), 1) %>'></asp:Label>
                                                </b></td>
                                        </tr>
                                        <tr>
                                            <td align="center" valign="top" class="pageHeaderStyle">
