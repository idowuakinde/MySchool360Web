<%@ Page Language="VB" AutoEventWireup="false" CodeFile="principal_comments_classes_step1.aspx.vb" Inherits="modules_data_principal_comments_classes_step1" %>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" 
                            NavigateUrl='<%# "principal_comments_classes_step2.aspx?a=" & Databinder.Eval(Container.DataItem, "ClassName").ToString %>' Font-Bold="True">Principal's Comments &gt;&gt;</asp:HyperLink>
                    </ItemTemplate>
