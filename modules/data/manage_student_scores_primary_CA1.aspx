<%@ Page Language="VB" AutoEventWireup="false" CodeFile="manage_student_scores_primary_CA1.aspx.vb" Inherits="modules_data_manage_student_scores_primary_CA1" %>
    ...
    <div>
        ...
        <asp:GridView ID="gvMaster" runat="server" CssClass="noBorderedMenuTable" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Cycle Test" SortExpression="ScoreClassTest">
                    <ItemTemplate>
                        ...
                        <asp:ObjectDataSource ID="dsObjScores2" runat="server" 
                            ...
                            <SelectParameters>
                                <asp:Parameter DefaultValue="0" Name="minimum" Type="Double" />
                                <asp:Parameter DefaultValue="20" Name="maximum" Type="Double" />
                                <asp:Parameter DefaultValue="0.5" Name="interval" Type="Double" />
                            </SelectParameters>
                        </asp:ObjectDataSource>
                    </ItemTemplate>
