...
Partial Class modules_data_email_to_parents3
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For i As Int32 = 1 To recipientCollection.Count
            ...
            bccAddresses = ""
            subject = "Your child's result for the 2nd Term Before Mid-Term Assessment at Childville (Portal Number: " & portalNumber & ", Class: " & className.ToUpper & ")"
            bodyFormat = 1          '1 for text, 0 for html
            body = Common.EncodeHTML("Please find attached." & vbCrLf & vbCrLf & "From Childville Schools.")
            attachment = Server.MapPath("~/_pdf/results/Childville_ReportCard_20122ndTermMid_" & portalNumber & ".PDF")
