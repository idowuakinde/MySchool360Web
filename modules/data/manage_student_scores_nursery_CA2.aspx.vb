...
Partial Class modules_data_manage_student_scores_nursery_CA2
    ...
    Protected Sub btnSaveScores_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveScores.Click
        ...
        For i As Int32 = 0 To Me.gvMaster.Rows.Count - 1
            ...
            Dim total As Int32 = subjectScoreCycleTest : CType(Me.gvMaster.Rows(i).FindControl("lblTotal"), Label).Text = total
            ...
            sqlInsert &= "ELSE "
            sqlInsert &= "      INSERT INTO dbo.TEMPStudentSubjectScore2(PortalNumber, SubjectShortName, SessionName, TermName, AssessmentType, Score, Comment) "
