...
Partial Class modules_data_print_student_result_primary_CA4_pdf
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            'theID = theDoc.AddImageUrl("http://localhost/myschool360.childville/modules/data/print_student_result_primary_CA4.aspx?a=" & portalNumber & "&b=" & sessionName & "&c=" & Common.GetRandomNumberBasedOnCurrentTime(500000))
            theID = theDoc.AddImageUrl("http://childville.myschool360.info/modules/data/print_student_result_primary_CA4.aspx?a=" & portalNumber & "&b=" & sessionName & "&c=" & Common.GetRandomNumberBasedOnCurrentTime(500000))
