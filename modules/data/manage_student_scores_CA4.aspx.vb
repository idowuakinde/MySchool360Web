...
Partial Class modules_data_manage_student_scores_CA4
        ...
        Select Case className.ToUpper
            Case "YEAR 7", "YEAR 8", "YEAR 9", "YEAR 10", "YEAR 11"
                Select Case subjectShortName.ToUpper
                    Case "MUSIC"
                        Server.Transfer("manage_student_scores_special_CA4.aspx", True)
                    Case "PHYSICAL EDUCATION", "PE"
                        Server.Transfer("manage_student_scores_special_PE_CA4.aspx", True)
                    Case Else
                        'do nothing
                End Select
            Case Else
