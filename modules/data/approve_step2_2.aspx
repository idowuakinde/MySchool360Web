<%@ Page Language="VB" AutoEventWireup="false" CodeFile="approve_step2_2.aspx.vb" Inherits="modules_data_approve_step2_2" %>
        ...
        <asp:GridView ID="gvMaster" runat="server" CssClass="noBorderedMenuTable" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:TemplateField HeaderText="Actions">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlnkPrint" runat="server" Font-Bold="True" NavigateUrl='<%# Common.GetStudentResultsApprovalPage2(Databinder.Eval(Container.DataItem, "ClassName").ToString, termName) & "?a=" & Databinder.Eval(Container.DataItem, "PortalNumber").ToString %>'>Review Result</asp:HyperLink>
                        <br />
                        <br />
