<%@ Page Language="VB" AutoEventWireup="false" CodeFile="approve_student_result_prenursery_CA4.aspx.vb" Inherits="modules_data_approve_student_result_prenursery_CA4" %>
						...
						<table width="100%" border="0">
                            <tr>
                                ...
                                <td align="left" valign="top">
                                    <input name="btnPrint" type="button" class="defaultButtonStyle" id="btnPrint" value="   Print This Page   " onclick="javascript:document.getElementById('btnPrint').style.display = 'none';GenerateDynamicPDF('print_student_result_prenursery_CA4_pdf.aspx?a=<%= portalNumber %>');" />
                                </td>
                            </tr>
                            <tr>
                                <td height="50">
                                    ...
                                    <tr>
                                        <td width="47%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td height="25" align="center" class="borderedTable">5.</td>
                                                    <td class="borderedTable">Writes using pictures / symbols / letters</td>
                                                    <td align="center" class="borderedTable">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="borderedTable">Identifies lower case letters</td>
                                                    <td align="center" class="borderedTable">
                                        ...
                                        <td width="47%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td height="25" align="center" class="borderedTable">2.</td>
                                                <td class="borderedTable">Letters</td>
                                                <td align="center" class="borderedTable">
                                    ...
                                    <tr>
                                        <td align="center" colspan="3" valign="top">
                                            <asp:Button ID="btnSaveScores" runat="server" CssClass="defaultButtonStyle" 
                                                Text="      Save Edited Comments &gt;      " CommandName="Select" 
