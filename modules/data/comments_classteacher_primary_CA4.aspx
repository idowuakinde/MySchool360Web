<%@ Page Language="VB" AutoEventWireup="false" CodeFile="comments_classteacher_primary_CA4.aspx.vb" Inherits="modules_data_comments_classteacher_primary_CA4" %>
        ...
        <table border="0" width="880">
            <tr>
                <td>
                        ...
                        Text=":: Append Class Teacher Comments (Primary School, AFTER the Mid-Term)"></asp:Label></td>
            </tr>
            <tr>
                <td align="center">
                                    ...
                                    <asp:GridView ID="gvDetail" runat="server" AllowSorting="True" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="SUBJECT" SortExpression="SubjectName">
                                                <FooterTemplate>
                                                    <asp:Label ID="Label8" runat="server" Text="PUPIL'S AVERAGE:"></asp:Label>
                                                    <br />
                                                    <br />
                                            ...
                                            <asp:TemplateField HeaderText="AVERAGE" SortExpression="">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label10" runat="server" 
                                                        Text='<%# FormatNumber(Common.GetClassSubjectAverage(className, CType(Databinder.Eval(Container.DataItem, "SubjectShortName"), String), sessionName, TermName, assessmentType), 1) %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                                <HeaderStyle HorizontalAlign="Right" />
                                        ...
                                        <tr>
                                          <td align="center" colspan="3" valign="top"><table width="90%" border="0">
                                            ...
                                            <tr>
                                              ...
                                              <td align="left"><strong>D</strong>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;50 to 59%</td>
                                            </tr>
                                            <tr>
