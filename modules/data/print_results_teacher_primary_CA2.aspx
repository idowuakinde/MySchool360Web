<%@ Page Language="VB" AutoEventWireup="false" CodeFile="print_results_teacher_primary_CA2.aspx.vb" Inherits="modules_data_print_results_teacher_primary_CA2" %>
        ...
        <asp:GridView ID="gvMaster" runat="server" CssClass="noBorderedMenuTable" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:TemplateField HeaderText="Actions">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlnkPrint" runat="server" Font-Bold="True" NavigateUrl='<%# "print_student_result_primary_CA2.aspx?a=" & Databinder.Eval(Container.DataItem, "PortalNumber").ToString %>'>Print Result</asp:HyperLink>
                    </ItemTemplate>
