<%@ Page Language="VB" AutoEventWireup="false" CodeFile="approve_step0.aspx.vb" Inherits="modules_data_approve_step0" %>
          ...
          <tr>
            <td>
                <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="Small" 
                    Text=":: All teachers are listed below. <br />&nbsp;&nbsp;&nbsp;&nbsp;Please click a teacher's name to proceed to their subjects.<br />&nbsp;&nbsp;&nbsp;&nbsp;Alternatively, you can click <a href='pr_batch_result_step0.aspx'>here</a> to print results in batches."></asp:Label></td>
          </tr>
          <tr>
            <td>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" 
                            NavigateUrl='<%# "approve_step2.aspx?a=" & Databinder.Eval(Container.DataItem, "Username").ToString & "&b=" & Databinder.Eval(Container.DataItem, "TeacherName").ToString & "&c=" & Request.QueryString("a") %>' Font-Bold="True">View Subjects &gt;&gt;</asp:HyperLink>
                    </ItemTemplate>
