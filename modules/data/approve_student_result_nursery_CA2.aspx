<%@ Page Language="VB" AutoEventWireup="false" CodeFile="approve_student_result_nursery_CA2.aspx.vb" Inherits="modules_data_approve_student_result_nursery_CA2" %>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td align="right" colspan="4">
                                                <input name="btnPrint" type="button" class="defaultButtonStyle" id="btnPrint" value="   Print This Page   " onclick="javascript:document.getElementById('btnPrint').style.display = 'none';GenerateDynamicPDF('print_student_result_nursery_CA2_pdf.aspx?a=<%= portalNumber %>');" />
                                            </td>
                                        </tr>
