<%@ Page Language="VB" AutoEventWireup="false" CodeFile="print_student_result_primary_CA6.aspx.vb" Inherits="modules_data_print_student_result_primary_CA6" %>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td align="right" colspan="4">
                                                <input name="btnPrint" type="button" class="defaultButtonStyle" id="btnPrint" value="   Print This Page   " onclick="javascript:document.getElementById('btnPrint').style.display = 'none';GenerateDynamicPDF('print_student_result_primary_CA6_pdf.aspx?a=<%= portalNumber %>&c=<%= sessionName %>');" />
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td align="center" valign="top">
                                    <asp:GridView ID="gvDetail" runat="server" AllowSorting="True" 
                                        ...
                                        OnRowDataBound="gvDetail_RowDataBound" PageSize="1" ShowFooter="True" 
                                        Width="98%">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="SUBJECT" SortExpression="SubjectName">
                                                <FooterTemplate>
                                                    <asp:Label ID="Label11" runat="server" Text="PUPIL'S AVERAGE:"></asp:Label><br /><br />
                                            ...
                                            <asp:TemplateField HeaderText="SCORE" SortExpression="TermEndSubjectScore">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server" 
                                                        Text='<%# FormatNumber(CType(Databinder.Eval(Container.DataItem, "MidTermSubjectScore"), Double) + CType(Databinder.Eval(Container.DataItem, "TermEndSubjectScore"), Double), 1) %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="<%# FormatNumber(innerTotal / innerSerial, 1) %>"></asp:Label><br /><br />
                                                    <asp:Label ID="Label12" runat="server" Font-Bold="True" Text="<%# FormatNumber(Common.GetClassAverage(className, sessionName, TermName, assessmentType), 1) %>"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                        ...
                                        <tr>
                                          <td align="left" colspan="3" valign="top" class="pageHeaderStyle">Number of Days 
                                              ...
                                              <asp:Label ID="Label13" runat="server" 
                                                  Text='<%# CType(Databinder.Eval(Container.DataItem, "Handwriting"), String) %>'></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                          <td align="left" colspan="3" valign="top" class="pageHeaderStyle">&nbsp;</td>
