...
Partial Class modules_data_approve_nursery_CA1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.lblHeader.Text = ":: Review Students' Scores for Half-Term. (SUBJECT: " & subjectShortName & ", CLASS: " & className & ")"
    End Sub
    ...
    Protected Sub btnReject_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReject.Click
        ...
        For i As Int32 = 0 To Me.gvMaster.Rows.Count - 1
            ...
            'approve the scores
            Dim sqlUpdate As String = " UPDATE dbo.TEMPStudentSubjectScore SET Remark1 = NULL WHERE ScoreId = " & scoreId & " "
    ...
    Protected Sub btnApprove_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnApprove.Click
        ...
        For i As Int32 = 0 To Me.gvMaster.Rows.Count - 1
            ...
            'approve the scores
            Dim sqlUpdate As String = " UPDATE dbo.TEMPStudentSubjectScore SET Remark1 = 'Approved' WHERE ScoreId = " & scoreId & " "
            'Response.Write(sqlUpdate)
            updateResponse += Common.UpdateTableRow(sqlUpdate)
        Next
    ...
    Protected Sub btnEmailBatch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEmailBatch.Click
        Response.Redirect("email_to_parents.aspx?a=subject&b=" & subjectShortName)
    End Sub
    ...
    Protected Sub btnPrintBatch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrintBatch.Click
        ...
        For i As Int32 = 0 To Me.gvMaster.Rows.Count - 1
            ...
            'theDoc.AddImageUrl("http://localhost/myschool360.childville/modules/data/print_student_result.asp?a=" & portalNumber)
            theDoc.AddImageUrl("http://childville.myschool360.info/modules/data/print_student_result.asp?a=" & portalnumber)
        Next
        theData = theDoc.GetData()
        Response.ContentType = "application/pdf"
        Response.AddHeader("content-length", UBound(theData) - LBound(theData) + 1)
        Response.AddHeader("content-disposition", "attachment; filename=Childville_ReportCard_2012HalfTermReport_" & className & "_" & subjectShortName & ".PDF")
