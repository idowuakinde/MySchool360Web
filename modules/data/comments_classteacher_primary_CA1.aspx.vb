...
Partial Class modules_data_comments_classteacher_primary
    Inherits System.Web.UI.Page

    Public serialNumber As Int32 = 0, innerSerial As Int32 = 0, innerTotal As Int32 = 0, innerAverage As Int32 = 0, username As String = "", className As String = "", assessmentType As String = "Test"
    ...
    Public Sub SaveComments(ByVal currentRow As GridViewRow)
        ...
        sqlInsert &= "ELSE "
        sqlInsert &= "      INSERT INTO dbo.TEMPStudentSubjectScoreTeacherComment(PortalNumber, SessionName, TermName, AssessmentType, Score_PE, ClubsAndExtras, DaysAbsent, Punctuality, ClassTeacherComment) "
        sqlInsert &= "      VALUES('" & portalNumber & "','" & sessionName & "','" & TermName & "','" & assessmentType & "','" & scorePE & "','" & scoreClubsAndExtras & "'," & scoreDaysAbsent & "," & scorePunctuality & ",'" & comment & "')"
