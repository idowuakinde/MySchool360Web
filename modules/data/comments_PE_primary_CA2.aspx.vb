...
Partial Class modules_data_comments_PE_primary_CA2
    Inherits System.Web.UI.Page

    Public serialNumber As Int32 = 0, username As String = "", className As String = "", assessmentType As String = "Test2"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        Me.lblHeader.Text = ":: Append Physical Education Comments (Primary School, AFTER the Mid-Term)"

        Me.dsSqlSubjects.SelectCommand = " SELECT a.CustomerId, a.DistrictCode AS ClassName, a.CustomerCode as PortalNumber, UPPER(a.LastName) + ' ' + a.FirstName AS StudentNames, b.Score_PE FROM dbo.TEMPCustomers a LEFT JOIN dbo.TEMPStudentSubjectScoreTeacherComment2 b ON a.CustomerCode = b.PortalNumber AND b.SessionName = '" & sessionName & "' AND b.TermName = '" & TermName & "' AND b.AssessmentType = '" & assessmentType & "' INNER JOIN dbo.TEMPClass c ON a.DistrictCode = c.ClassName WHERE a.DistrictCode IN (SELECT ClassName FROM dbo.TEMPClass WHERE Remarks = 'PRI') ORDER BY c.ListingOrder, a.DistrictCode, StudentNames "
    ...
    Public Sub SavePEComments(ByVal currentRow As GridViewRow)
        ...
        sqlInsert &= "ELSE "
        sqlInsert &= "      INSERT INTO dbo.TEMPStudentSubjectScoreTeacherComment2(PortalNumber, SessionName, TermName, AssessmentType, Score_PE) "
