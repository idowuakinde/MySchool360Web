<%@ Page Language="VB" AutoEventWireup="false" CodeFile="manage_student_scores_special_PE_CA6.aspx.vb" Inherits="modules_data_manage_student_scores_special_PE_CA6" %>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:ObjectDataSource ID="dsObjScores" runat="server" 
                            ...
                            <SelectParameters>
                                ...
                                <asp:Parameter DefaultValue="80" Name="maximum" Type="Double" />
