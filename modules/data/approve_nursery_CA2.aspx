<%@ Page Language="VB" AutoEventWireup="false" CodeFile="approve_nursery_CA2.aspx.vb" Inherits="modules_data_approve_nursery_CA2" %>
        ...
        <asp:GridView ID="gvMaster" runat="server" CssClass="noBorderedMenuTable" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Comments">
                    <ItemTemplate>
                        <asp:Label ID="Label4" runat="server" style="font-weight: 700" Text='<%# Bind("Comment") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Width="250px" />
                </asp:TemplateField>
            </Columns>
