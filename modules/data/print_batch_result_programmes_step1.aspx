<%@ Page Language="VB" AutoEventWireup="false" CodeFile="print_batch_result_programmes_step1.aspx.vb" Inherits="modules_data_print_batch_result_programmes_step1" %>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" 
                            NavigateUrl='<%# "print_batch_result_programmes_step2.aspx?a=" & Databinder.Eval(Container.DataItem, "ProgrammeName").ToString %>' Font-Bold="True">Print Results &gt;&gt;</asp:HyperLink>
                    </ItemTemplate>
