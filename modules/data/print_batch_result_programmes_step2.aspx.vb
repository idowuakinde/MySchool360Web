...
Partial Class modules_data_print_batch_result_programmes_step2
    Inherits System.Web.UI.Page

    Public serialNumber As Int32 = 0, programmeName As String = "", assessmentType As String = "Test"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        programmeName = Request.QueryString("a")
    End Sub
    ...
    Protected Sub btnPrintBatch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrintBatch.Click
        ...
        Response.AddHeader("content-disposition", "attachment; filename=Oxbridge_ReportCard_2012SeptemberTest_" & programmeName & ".pdf")
    ...
    Protected Sub btnEmailBatch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEmailBatch.Click
        Response.Redirect("email_to_parents.aspx?a=programme&b=" & programmeName)
    End Sub
