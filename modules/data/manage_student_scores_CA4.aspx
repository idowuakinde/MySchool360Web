<%@ Page Language="VB" AutoEventWireup="false" CodeFile="manage_student_scores_CA4.aspx.vb" Inherits="modules_data_manage_student_scores_CA4" %>
    ...
    <div>
        ...
        <asp:GridView ID="gvMaster" runat="server" CssClass="noBorderedMenuTable" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Exam" SortExpression="Score">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Class Test" SortExpression="ScoreClassTest">
                    <ItemTemplate>
                        <asp:Label ID="lblMidTermClassTest" runat="server" Text='<%# "Before Mid-Term: " & Common.GetScoreMask(Common.GetMidTermScore(CType(Databinder.Eval(Container.DataItem, "PortalNumber"), String), CType(Databinder.Eval(Container.DataItem, "ClassName"), String), subjectShortName, sessionName, termName, "ClassTest"), CType(Databinder.Eval(Container.DataItem, "ClassName"), String)) %>'></asp:Label>
                        <br />
                        <asp:DropDownList ID="ddlClassTests" runat="server" AppendDataBoundItems="True" 
                            CssClass="defaultFormElementStyle" DataSourceID="dsObjScores2" 
                            SelectedValue='<%# CType(Databinder.Eval(Container.DataItem, "ScoreClassTest"), Int32) %>'>
                            <asp:ListItem Value="-2">Not Enrolled</asp:ListItem>
                            <asp:ListItem Value="-1">Absent</asp:ListItem>
                        </asp:DropDownList>
                        <asp:ObjectDataSource ID="dsObjScores2" runat="server" 
                            ...
                            <SelectParameters>
                                <asp:Parameter DefaultValue="0" Name="minimum" Type="Double" />
                                <asp:Parameter DefaultValue="30" Name="maximum" Type="Double" />
                                <asp:Parameter DefaultValue="0.5" Name="interval" Type="Double" />
                            </SelectParameters>
                        </asp:ObjectDataSource>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Assignments" SortExpression="ScoreAssignments">
                    <ItemTemplate>
                        <asp:Label ID="lblMidTermAssignment" runat="server" Text='<%# "Before Mid-Term: " & Common.GetScoreMask(Common.GetMidTermScore(CType(Databinder.Eval(Container.DataItem, "PortalNumber"), String), CType(Databinder.Eval(Container.DataItem, "ClassName"), String), subjectShortName, sessionName, termName, "Assignment"), CType(Databinder.Eval(Container.DataItem, "ClassName"), String)) %>'></asp:Label>
                        <br />
                        <asp:DropDownList ID="ddlAssignments" runat="server" AppendDataBoundItems="True" 
                            CssClass="defaultFormElementStyle" DataSourceID="dsObjScores3" 
                            SelectedValue='<%# CType(Databinder.Eval(Container.DataItem, "ScoreAssignments"), Int32) %>'>
                            <asp:ListItem Value="-2">Not Enrolled</asp:ListItem>
                            <asp:ListItem Value="-1">Absent</asp:ListItem>
                        </asp:DropDownList>
                        <asp:ObjectDataSource ID="dsObjScores3" runat="server" 
                            SelectMethod="GetDoubleSeries" TypeName="Common">
                            <SelectParameters>
                                <asp:Parameter DefaultValue="0" Name="minimum" Type="Double" />
                                <asp:Parameter DefaultValue="10" Name="maximum" Type="Double" />
                                <asp:Parameter DefaultValue="0.5" Name="interval" Type="Double" />
                            </SelectParameters>
                        </asp:ObjectDataSource>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Class Work" SortExpression="ScoreClassWork">
                    <ItemTemplate>
                        <asp:Label ID="lblMidTermClassWork" runat="server" Text='<%# "Before Mid-Term: " & Common.GetScoreMask(Common.GetMidTermScore(CType(Databinder.Eval(Container.DataItem, "PortalNumber"), String), CType(Databinder.Eval(Container.DataItem, "ClassName"), String), subjectShortName, sessionName, termName, "ClassWork"), CType(Databinder.Eval(Container.DataItem, "ClassName"), String)) %>'></asp:Label>
                        <br />
                        <asp:DropDownList ID="ddlScoreClassWork" runat="server" 
                            AppendDataBoundItems="True" CssClass="defaultFormElementStyle" 
                            DataSourceID="dsObjScores4" 
                            SelectedValue='<%# CType(Databinder.Eval(Container.DataItem, "ScoreClassWork"), Int32) %>'>
                            <asp:ListItem Value="-2">Not Enrolled</asp:ListItem>
                            <asp:ListItem Value="-1">Absent</asp:ListItem>
                        </asp:DropDownList>
                        <asp:ObjectDataSource ID="dsObjScores4" runat="server" 
                            SelectMethod="GetDoubleSeries" TypeName="Common">
                            <SelectParameters>
                                <asp:Parameter DefaultValue="0" Name="minimum" Type="Double" />
                                <asp:Parameter DefaultValue="10" Name="maximum" Type="Double" />
