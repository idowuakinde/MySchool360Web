<%@ Page Language="VB" AutoEventWireup="false" CodeFile="nurseryskills_step2.aspx.vb" Inherits="modules_data_nurseryskills_step2" %>
        ...
        <asp:GridView ID="gvMaster" runat="server" CssClass="noBorderedMenuTable" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:TemplateField HeaderText="Actions">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlnkEnterSkillsReport" runat="server" Font-Bold="True" 
                            NavigateUrl=''>Enter Skills Assessment</asp:HyperLink>
                        <br />
                        <br />
                    </ItemTemplate>
