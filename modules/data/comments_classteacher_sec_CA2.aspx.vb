...
Partial Class modules_data_comments_classteacher_sec_CA2
    Inherits System.Web.UI.Page

    Public serialNumber As Int32 = 0, innerSerial As Int32 = 0, innerTotal As Int32 = 0, innerAverage As Int32 = 0, username As String = "", className As String = "", assessmentType As String = "Test2", currentSubjectShortName As String = ""
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Select Case rowView("SubjectName").ToString.ToUpper
                Case "MUSIC"
                    ...
                    e.Row.Cells(3).Text = "<table align='left' border='1' class='style17'><tr><td align='center'>50</td></tr><tr><td align='center'>50</td></tr><tr><td align='center'>100</td></tr><tr><td align='center'>100</td></tr><tr><td align='center' bgcolor='#CCCCCCC'><strong>100</strong></td></tr><tr><td align='center' bgcolor='#CCCCCCC'><strong>100</strong></td></tr></table>"
                    e.Row.Cells(4).Text = "<table align='left' border='1' class='style17'><tr><td align='center'>" & Math.Ceiling(CType(rowView("CycleTest"), Double)).ToString & "</td></tr><tr><td align='center'>" & Math.Ceiling(CType(rowView("ClassTests"), Double)).ToString & "</td></tr><tr><td align='center'>" & Math.Ceiling(CType(rowView("TermEndSubjectScore"), Double)).ToString & "</td></tr><tr><td align='center'>" & Math.Ceiling(CType(rowView("MidTermSubjectScore"), Double)).ToString & "</td></tr><tr><td align='center' bgcolor='#CCCCCCC'><strong>" & Math.Ceiling(termSubjectOverallTotal).ToString & " (" & Common.GetGradeSchool2(termSubjectOverallTotal, className).Split(",")(0) & ")</strong></td></tr><tr><td align='center' bgcolor='#CCCCCCC'><strong>" & Math.Ceiling(Common.GetClassSubjectAverage(className, currentSubjectShortName, sessionName, TermName, assessmentType)).ToString & "</strong></td></tr></table>"
                ...
                Case "PE", "PHYSICAL EDUCATION"
                    Dim termSubjectOverallTotal As Double = Math.Ceiling((CType(rowView("MidTermSubjectScore"), Double) + CType(rowView("TermEndSubjectScore"), Double)) / 2)
                    e.Row.Cells(2).Text = "<table align='left' border='1' class='style17'><tr><td>INVOLVEMENT</td></tr><tr><td>KNOWLEDGE</td></tr><tr><td><strong>TOTAL 2<sup>nd</sup> HALF</strong></td></tr><tr><td><strong>TOTAL 1<sup>st</sup> HALF</strong></td></tr><tr><td bgcolor='#CCCCCCC'><strong>TERM TOTAL</strong></td></tr><tr><td bgcolor='#CCCCCCC'><strong>CLASS SUBJECT AVERAGE</strong></td></tr></table>"
                    e.Row.Cells(3).Text = "<table align='left' border='1' class='style17'><tr><td align='center'>80</td></tr><tr><td align='center'>20</td></tr><tr><td align='center'>100</td></tr><tr><td align='center'>100</td></tr><tr><td align='center' bgcolor='#CCCCCCC'><strong>100</strong></td></tr><tr><td align='center' bgcolor='#CCCCCCC'><strong>100</strong></td></tr></table>"
                    e.Row.Cells(4).Text = "<table align='left' border='1' class='style17'><tr><td align='center'>" & Math.Ceiling(CType(rowView("CycleTest"), Double)).ToString & "</td></tr><tr><td align='center'>" & Math.Ceiling(CType(rowView("ClassTests"), Double)).ToString & "</td></tr><tr><td align='center'>" & Math.Ceiling(CType(rowView("TermEndSubjectScore"), Double)).ToString & "</td></tr><tr><td align='center'>" & Math.Ceiling(CType(rowView("MidTermSubjectScore"), Double)).ToString & "</td></tr><tr><td align='center' bgcolor='#CCCCCCC'><strong>" & Math.Ceiling(termSubjectOverallTotal).ToString & " (" & Common.GetGradeSchool2(termSubjectOverallTotal, className).Split(",")(0) & ")</strong></td></tr><tr><td align='center' bgcolor='#CCCCCCC'><strong>" & Math.Ceiling(Common.GetClassSubjectAverage(className, currentSubjectShortName, sessionName, TermName, assessmentType)).ToString & "</strong></td></tr></table>"
                    e.Row.Cells(5).Text = "<table align='left' border='1' class='style17'><tr><td align='left' height='90' valign='top'><span>" & CType(rowView("SubjectComment"), String).Replace("''", "'") & "</span></td></tr></table>"
                    e.Row.BackColor = Drawing.Color.LightCyan
                    Call CountGrade(Common.GetGradeSchool2(termSubjectOverallTotal, className))
                Case Else
                    ...
                    e.Row.Cells(3).Text = "<table align='left' border='1' class='style17'><tr><td align='center'>50</td></tr><tr><td align='center'>30</td></tr><tr><td align='center'>10</td></tr><tr><td align='center'>10</td></tr><tr><td align='center'>100</td></tr><tr><td align='center'>100</td></tr><tr><td align='center' bgcolor='#CCCCCCC'><strong>100</strong></td></tr><tr><td align='center' bgcolor='#CCCCCCC'><strong>100</strong></td></tr></table>"
                    e.Row.Cells(4).Text = "<table align='left' border='1' class='style17'><tr><td align='center'>" & Math.Ceiling(CType(rowView("CycleTest"), Double)).ToString & "</td></tr><tr><td align='center'>" & Math.Ceiling(CType(rowView("ClassTests"), Double)).ToString & "</td></tr><tr><td align='center'>" & Math.Ceiling(CType(rowView("Assignments"), Double)).ToString & "</td></tr><tr><td align='center'>" & Math.Ceiling(CType(rowView("ClassWork"), Double)).ToString & "</td></tr><tr><td align='center'>" & Math.Ceiling(CType(rowView("TermEndSubjectScore"), Double)).ToString & "</td></tr><tr><td align='center'>" & Math.Ceiling(CType(rowView("MidTermSubjectScore"), Double)).ToString & "</td></tr><tr><td align='center' bgcolor='#CCCCCCC'><strong>" & Math.Ceiling(termSubjectOverallTotal).ToString & " (" & Common.GetGradeSchool2(termSubjectOverallTotal, className).Split(",")(0) & ")</strong></td></tr><tr><td align='center' bgcolor='#CCCCCCC'><strong>" & Math.Ceiling(Common.GetClassSubjectAverage(className, currentSubjectShortName, sessionName, TermName, assessmentType)).ToString & "</strong></td></tr></table>"
