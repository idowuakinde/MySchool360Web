<%@ Page Language="VB" AutoEventWireup="false" CodeFile="print_student_skillsreport_nursery_CA2.aspx.vb" Inherits="modules_data_print_student_skillsreport_nursery_CA2" %>
                        ...
                        Text=":: BEHAVIOURAL ASSESSMENT REPORT"></asp:Label>
                            ...
                            <td align="right" valign="top">
                                <input name="btnPrint" type="button" class="defaultButtonStyle" id="btnPrint" 
                                    ...
                                    onclick="javascript:document.getElementById('btnPrint').style.display = 'none';GenerateDynamicPDF('print_student_skillsreport_nursery_CA2_pdf.aspx?a=<%= portalNumber %>&c=<%= sessionName %>');" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
