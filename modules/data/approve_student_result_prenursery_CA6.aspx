<%@ Page Language="VB" AutoEventWireup="false" CodeFile="approve_student_result_prenursery_CA6.aspx.vb" Inherits="modules_data_approve_student_result_prenursery_CA6" %>
						...
						<table width="100%" border="0">
                            <tr>
                                ...
                                <td align="left" valign="top">
                                    <input name="btnPrint" type="button" class="defaultButtonStyle" id="btnPrint" value="   Print This Page   " onclick="javascript:document.getElementById('btnPrint').style.display = 'none';GenerateDynamicPDF('print_student_result_prenursery_CA6_pdf.aspx?a=<%= portalNumber %>');" />
                                </td>
                            </tr>
                            <tr>
                                <td height="50">
