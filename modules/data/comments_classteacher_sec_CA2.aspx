<%@ Page Language="VB" AutoEventWireup="false" CodeFile="comments_classteacher_sec_CA2.aspx.vb" Inherits="modules_data_comments_classteacher_sec_CA2" %>
        ...
        <table border="0" width="880">
            <tr>
                <td>
                        ...
                        Text=":: Append Class Teacher Comments (Secondary School, AFTER the Mid-Term)"></asp:Label></td>
            </tr>
            <tr>
                <td align="center">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td align="center" colspan="3" valign="top" class="pageHeaderStyle">
                                                ...
                                                <asp:Label ID="Label6" runat="server" Text="<%# Math.Ceiling(innerTotal / innerSerial) %>"></asp:Label>
                                                </b></td>
                                        </tr>
                                        <tr>
                                            <td align="center" colspan="3" valign="top" class="pageHeaderStyle">
                                                <b>CLASS AVERAGE SCORE:
                                                <asp:Label ID="lblClassAverage" runat="server" Text='<%# FormatNumber(Common.GetClassAverage(className, sessionName, TermName, "Test"), 1) %>'></asp:Label>
                                                </b></td>
                                        </tr>
                                        <tr>
                                            <td align="left" colspan="3" valign="top">
