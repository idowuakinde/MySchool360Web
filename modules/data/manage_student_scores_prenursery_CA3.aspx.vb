...
Partial Class modules_data_manage_student_scores_prenursery_CA3
    ...
    Public Sub SaveScores(ByVal currentRow As GridViewRow)
        ...
        sqlInsert = " IF EXISTS (SELECT ScoreId FROM dbo.TEMPStudentSubjectScore_Nursery WHERE PortalNumber = '" & portalNumber & "' AND Remark1 = '" & subjectShortName & "' AND SessionName = '" & sessionName & "' AND TermName = '" & TermName & "' AND AssessmentType = '" & assessmentType & "') "
        sqlInsert &= "      UPDATE dbo.TEMPStudentSubjectScore_Nursery "
