<%@ Page Language="VB" AutoEventWireup="false" CodeFile="timetable_teacher.aspx.vb" Inherits="modules_timetable_timetable_teacher" %>
            ...
            <table width="" border="0" cellpadding="0" cellspacing="0">
                <tr align="center" valign="middle">
                    ...
                    <% end if %>
                        ...
                        <%--<td width="120" bgcolor="#999999" class="borderedTable">PERIOD <%= i %></td>--%>
                    <% Next %>
                </tr>
                <tr align="center" valign="middle">
