<%@ Page Language="VB" AutoEventWireup="false" CodeFile="timetable_class_load_all.aspx.vb" Inherits="modules_timetable_timetable_class_load_all" %>
          ...
          <tr>
            ...
            <td>
                <asp:GridView ID="gvTeachers" runat="server" AutoGenerateColumns="False" 
                        DataKeyNames="ClassName" DataSourceID="dsSqlClasses" Width="100%" 
                    ...
                    <asp:TemplateField HeaderText="Periods">
                        <ItemTemplate>
                            ...
                            <asp:SqlDataSource ID="dsSqlGetClassLoad" runat="server" 
                                ...
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="gvTeachers" Name="ClassName" 
                ...
                <EditRowStyle CssClass="defaultFormElementStyle" />
                    ...
                    SelectCommand="SELECT [ClassId], [ClassName] FROM [TEMPClass]">
                    </asp:SqlDataSource>
                </td>
          </tr>
          <tr>
