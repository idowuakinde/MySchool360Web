<%@ Page Language="VB" AutoEventWireup="false" CodeFile="timetable_venue_load_all.aspx.vb" Inherits="modules_timetable_timetable_venue_load_all" %>
        ...
        <table width="880"  border="0" id="TABLE1" onclick="return TABLE1_onclick()">
            <tr>
                <td colspan="2">
                    <table width="100%">
                        <tr>
                            <td width="400"><asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="Small" Text=":: VENUE LOAD"></asp:Label></td>
          ...
          <tr>
            ...
            <td>
                <asp:GridView ID="gvTeachers" runat="server" AutoGenerateColumns="False" 
                        DataKeyNames="VenueName" DataSourceID="dsSqlVenues" Width="100%" 
                        EmptyDataText="No venues to display." 
                    ...
                    <asp:TemplateField HeaderText="Periods Taught">
                        <ItemTemplate>
                            <asp:Label ID="Label11" runat="server" Font-Bold="True" 
                                Text='<%# CType(Databinder.Eval(Container.DataItem, "VenueName"), String).ToUpper %>'></asp:Label>
                            <br />&nbsp;
                            <table width="100%">
                                <tr>
                                    <td width="30">
                                    ...
                                    <td>
                                        <asp:GridView ID="gvTeacherLoad" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField FooterText="Total Venue Load (Periods Occupied per Week):" 
                                                    HeaderText="Subject" SortExpression="SubjectName">
                                                    <ItemTemplate>
                            ...
                            <asp:SqlDataSource ID="dsSqlGetVenueLoad" runat="server" 
                                ...
                                SelectCommand="SELECT a.PeriodId, d.VenueName, dbo.FUNC_GET_WEEKDAYNAME([DayOfWeek]) as DayOfWeekName, PeriodNumber, b.ClassName, c.SubjectName, e.FirstName + ' ' + e.Surname as TeacherName FROM [dbo].[Core_TimetablePeriod] a INNER JOIN dbo.TEMPClass b ON a.ClassId  = b.ClassId INNER JOIN dbo.TEMPSubject c ON a.SubjectId = c.SubjectId INNER JOIN dbo.Core_TuitionVenue d ON a.RoomId = d.VenueId INNER JOIN dbo.Core_User e ON a.Remark1 = e.Username WHERE d.VenueName = @VenueName ORDER BY d.VenueName, [DayOfWeek], PeriodNumber, ClassName, SubjectName, TeacherName">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="gvTeachers" Name="VenueName" PropertyName="SelectedValue" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </ItemTemplate>
                ...
                <EditRowStyle CssClass="defaultFormElementStyle" />
                    ...
                    SelectCommand="SELECT VenueId, VenueName FROM dbo.Core_TuitionVenue ORDER BY VenueName">
                    </asp:SqlDataSource>
                </td>
          </tr>
          <tr>
