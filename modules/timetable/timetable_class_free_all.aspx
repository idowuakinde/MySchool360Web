<%@ Page Language="VB" AutoEventWireup="false" CodeFile="timetable_class_free_all.aspx.vb" Inherits="modules_timetable_timetable_class_free_all" %>
        ...
        <table width="1100"  border="0" id="TABLE1" onclick="return TABLE1_onclick()">
            <tr>
                <td colspan="2">
                    <table width="100%">
                        <tr>
                            <td width="700"><asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="Small" Text=":: CLASS FREE SLOTS"></asp:Label></td>
            ...
            <table width="" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr align="center" valign="middle">
                    ...
                    <td height="70" bgcolor="#999999" class="borderedTable">
						...
						<% For j As Int32 = 0 To rcClasses.Count - 1 %>
                            <tr align="center" valign="middle">
                                <td class="borderedTableGrey" height="30"><%= rcClasses(j).Item(0).ToString %></td>
                            </tr>
                        <% Next %>
                        </table>
                    </td>
                    <% For i As Int32 = 1 To periodsPerDay%>
                        <td width="100" class="borderedTable">
						    ...
						    <% For j As Int32 = 0 To rcClasses.Count - 1 %>
                                <tr align="center" valign="middle">
                                    <td class="borderedTableGrey" height="30"><%= GetTimeTablePeriod(1, i, rcClasses(j).Item(0).ToString) %></td>
                                </tr>
                            <% Next %>
                            </table>
                        </td>
                ...
                <tr align="center" valign="middle">
                    ...
                    <% For i As Int32 = 1 To periodsPerDay%>
                        <td width="100" class="borderedTable">
						    ...
						    <% For j As Int32 = 0 To rcClasses.Count - 1 %>
                                <tr align="center" valign="middle">
                                    <td class="borderedTableGrey" height="30"><%= GetTimeTablePeriod(2, i, rcClasses(j).Item(0).ToString) %></td>
                                </tr>
                            <% Next %>
                            </table>
                        </td>
                ...
                <tr align="center" valign="middle">
                    ...
                    <% For i As Int32 = 1 To periodsPerDay%>
                        <td width="100" class="borderedTable">
						    ...
						    <% For j As Int32 = 0 To rcClasses.Count - 1 %>
                                <tr align="center" valign="middle">
                                    <td class="borderedTableGrey" height="30"><%= GetTimeTablePeriod(3, i, rcClasses(j).Item(0).ToString) %></td>
                                </tr>
                            <% Next %>
                            </table>
                        </td>
                ...
                <tr align="center" valign="middle">
                    ...
                    <% For i As Int32 = 1 To periodsPerDay%>
                        <td width="100" class="borderedTable">
						    ...
						    <% For j As Int32 = 0 To rcClasses.Count - 1 %>
                                <tr align="center" valign="middle">
                                    <td class="borderedTableGrey" height="30"><%= GetTimeTablePeriod(4, i, rcClasses(j).Item(0).ToString) %></td>
                                </tr>
                            <% Next %>
                            </table>
                        </td>
                ...
                <tr align="center" valign="middle">
                    ...
                    <% For i As Int32 = 1 To periodsPerDay%>
                        <td width="100" class="borderedTable">
						    ...
						    <% For j As Int32 = 0 To rcClasses.Count - 1 %>
                                <tr align="center" valign="middle">
                                    <td class="borderedTableGrey" height="30"><%= GetTimeTablePeriod(5, i, rcClasses(j).Item(0).ToString) %></td>
                                </tr>
                            <% Next %>
                            </table>
                        </td>
