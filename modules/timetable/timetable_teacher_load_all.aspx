<%@ Page Language="VB" AutoEventWireup="false" CodeFile="timetable_teacher_load_all.aspx.vb" Inherits="modules_timetable_timetable_teacher_load_all" %>
          ...
          <tr>
            ...
            <td>
                <asp:GridView ID="gvTeachers" runat="server" AutoGenerateColumns="False" 
                        DataKeyNames="Username" DataSourceID="dsSqlTeachers" Width="100%" 
                    ...
                    <asp:TemplateField HeaderText="Periods Taught">
                        <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:GridView ID="gvTeacherLoad" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            GridLines="None" ShowFooter="True" Width="100%" OnRowDataBound="InnerGrid_RowDataBound" OnDataBound="InnerGrid_DataBound">
                            ...
                            <asp:SqlDataSource ID="dsSqlGetTeacherLoad" runat="server" 
                                ...
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="gvTeachers" Name="Username" 
                ...
                <EditRowStyle CssClass="defaultFormElementStyle" />
                    ...
                    <asp:SqlDataSource ID="dsSqlTeachers" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                        SelectCommand="SELECT [Username], [Firstname] + ' ' + [Middlename] + ' ' + [Surname] AS FullName FROM [Core_User] ORDER BY [Middlename], [Surname]">
                    </asp:SqlDataSource>
                </td>
          </tr>
          <tr>
