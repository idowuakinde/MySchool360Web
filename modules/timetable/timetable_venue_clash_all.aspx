<%@ Page Language="VB" AutoEventWireup="false" CodeFile="timetable_venue_clash_all.aspx.vb" Inherits="modules_timetable_timetable_venue_clash_all" %>
          ...
          <tr>
            ...
            <td>
                ...
                <EditRowStyle CssClass="defaultFormElementStyle" />
                    ...
                    SelectCommand="SELECT VenueName, dbo.FUNC_GET_WEEKDAYNAME([DayOfWeek]) as DayOfWeekName, PeriodNumber, COUNT(b.VenueName) AS PeriodCount FROM dbo.Core_TimetablePeriod a INNER JOIN dbo.Core_TuitionVenue b ON a.RoomId = b.VenueId GROUP BY VenueName, dbo.FUNC_GET_WEEKDAYNAME([DayOfWeek]), PeriodNumber HAVING Count(VenueName) > 1">
                    </asp:SqlDataSource>
                </td>
          </tr>
          <tr>
