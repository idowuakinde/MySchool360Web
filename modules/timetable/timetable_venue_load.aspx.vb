...
Partial Class modules_timetable_timetable_venue_load
    Inherits System.Web.UI.Page

    Public venueName As String, SN As Int32 = 0, periodsPerDay As Int32 = 0

    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        venueName = Request.QueryString("a")
        Me.Label9.Text = ":: VENUE LOAD FOR " & venueName.ToUpper
