<%@ Page Language="VB" AutoEventWireup="false" CodeFile="timetable_teacher_free_all.aspx.vb" Inherits="modules_timetable_timetable_teacher_free_all" %>
        ...
        <table width="1100"  border="0" id="TABLE1" onclick="return TABLE1_onclick()">
            <tr>
                <td colspan="2">
                    <table width="100%">
                        <tr>
                            <td width="400"><asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="Small" Text=":: TEACHER FREE SLOTS"></asp:Label></td>
            ...
            <table width="" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr align="center" valign="middle">
                    ...
                    <td height="70" bgcolor="#999999" class="borderedTable">
						...
						<% For j As Int32 = 0 To rcTeachers.Count - 1%>
                            <tr align="center" valign="middle">
                                <td class="borderedTableGrey" height="30"><%= rcTeachers(j).Item(0).ToString%></td>
                            </tr>
                        <% Next %>
                        </table>
                    </td>
                    <% For i As Int32 = 1 To periodsPerDay%>
                        <td width="100" class="borderedTable">
						    ...
						    <% For j As Int32 = 0 To rcTeachers.Count - 1%>
                                <tr align="center" valign="middle">
                                    <td class="borderedTableGrey" height="30"><%= GetTimetablePeriod(1, i, rcTeachers(j).Item(0).ToString)%></td>
                                </tr>
                            <% Next %>
                            </table>
                        </td>
                ...
                <tr align="center" valign="middle">
                    ...
                    <% For i As Int32 = 1 To periodsPerDay%>
                        <td width="100" class="borderedTable">
						    ...
						    <% For j As Int32 = 0 To rcTeachers.Count - 1%>
                                <tr align="center" valign="middle">
                                    <td class="borderedTableGrey" height="30"><%= GetTimetablePeriod(2, i, rcTeachers(j).Item(0).ToString)%></td>
                                </tr>
                            <% Next %>
                            </table>
                        </td>
                ...
                <tr align="center" valign="middle">
                    ...
                    <% For i As Int32 = 1 To periodsPerDay%>
                        <td width="100" class="borderedTable">
						    ...
						    <% For j As Int32 = 0 To rcTeachers.Count - 1%>
                                <tr align="center" valign="middle">
                                    <td class="borderedTableGrey" height="30"><%= GetTimetablePeriod(3, i, rcTeachers(j).Item(0).ToString)%></td>
                                </tr>
                            <% Next %>
                            </table>
                        </td>
                ...
                <tr align="center" valign="middle">
                    ...
                    <% For i As Int32 = 1 To periodsPerDay%>
                        <td width="100" class="borderedTable">
						    ...
						    <% For j As Int32 = 0 To rcTeachers.Count - 1%>
                                <tr align="center" valign="middle">
                                    <td class="borderedTableGrey" height="30"><%= GetTimetablePeriod(4, i, rcTeachers(j).Item(0).ToString)%></td>
                                </tr>
                            <% Next %>
                            </table>
                        </td>
                ...
                <tr align="center" valign="middle">
                    ...
                    <% For i As Int32 = 1 To periodsPerDay%>
                        <td width="100" class="borderedTable">
						    ...
						    <% For j As Int32 = 0 To rcTeachers.Count - 1%>
                                <tr align="center" valign="middle">
                                    <td class="borderedTableGrey" height="30"><%= GetTimetablePeriod(5, i, rcTeachers(j).Item(0).ToString)%></td>
                                </tr>
                            <% Next %>
                            </table>
                        </td>
