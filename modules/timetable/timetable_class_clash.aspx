<%@ Page Language="VB" AutoEventWireup="false" CodeFile="timetable_class_clash.aspx.vb" Inherits="modules_timetable_timetable_class_clash" %>
          ...
          <tr>
            ...
            <td>
                ...
                <EditRowStyle CssClass="defaultFormElementStyle" />
                    ...
                    SelectCommand="SELECT b.ClassName, dbo.FUNC_GET_WEEKDAYNAME([DayOfWeek]) as DayOfWeekName, PeriodNumber, COUNT(ClassName) AS PeriodCount FROM dbo.Core_TimetablePeriod a INNER JOIN dbo.TEMPClass b ON a.ClassId = b.ClassId WHERE b.ClassName = @ClassName GROUP BY b.ClassName, dbo.FUNC_GET_WEEKDAYNAME([DayOfWeek]), PeriodNumber HAVING Count(ClassName) &gt; 1 ">
                        <SelectParameters>
                            <asp:QueryStringParameter Name="ClassName" QueryStringField="a" />
                        </SelectParameters>
                    </asp:SqlDataSource>
