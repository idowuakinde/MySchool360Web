<%@ Page Language="VB" AutoEventWireup="false" CodeFile="timetable_venue_all.aspx.vb" Inherits="modules_timetable_timetable_venue_all" %>
        ...
        <table width="1100"  border="0" id="TABLE1" onclick="return TABLE1_onclick()">
            <tr>
                <td colspan="2">
                    <table width="100%">
                        <tr>
                            <td width="400"><asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="Small" Text=":: VENUE TIMETABLE"></asp:Label></td>
