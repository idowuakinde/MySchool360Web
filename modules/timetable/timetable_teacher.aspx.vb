...
Partial Class modules_timetable_timetable_teacher
    ...
    Protected Sub form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles form1.Load
        ...
        Me.Label9.Text = ":: TEACHER TIMETABLE FOR " & username.ToUpper
    ...
    Public Function GetTimetablePeriod(ByVal dayOfWeek As Int32, ByVal periodNumber As Int32) As String
        ...
        Select Case rcPeriod.Count
            Case 0
                ret = "--"
            Case 1
                ret = "<b>" & rcPeriod(0).Item(4).ToString & "</b><br /> at <br /><b>" & rcPeriod(0).Item(5).ToString & "</b><br /> with <br /><b>" & rcPeriod(0).Item(3).ToString & "</b>"
            Case Else
                ret = "<a href='timetable_teacher_clash.aspx?a=" & username & "'><font color='red'><b>" & "CLASH !</b></font></a>"
        End Select
