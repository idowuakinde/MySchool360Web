<%@ Page Language="VB" AutoEventWireup="false" CodeFile="timetable_venue_load.aspx.vb" Inherits="modules_timetable_timetable_venue_load" %>
          ...
          <tr>
            ...
            <td>
                <asp:GridView ID="gvTeachers" runat="server" AutoGenerateColumns="False" 
                        DataKeyNames="VenueId" DataSourceID="dsSqlVenues" Width="100%" 
                                        ...
                                        <asp:GridView ID="gvTeacherLoad" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Subject" SortExpression="SubjectName" 
                                                    FooterText="Total Venue Load (Periods Occupied per Week):">
                                                    <ItemTemplate>
                ...
                <EditRowStyle CssClass="defaultFormElementStyle" />
                    ...
                    <asp:SqlDataSource ID="dsSqlGetVenueLoad" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                    ...
                    SelectCommand="SELECT VenueId, VenueName FROM dbo.Core_TuitionVenue WHERE VenueName = @VenueName ORDER BY VenueName">
                        <SelectParameters>
                            <asp:QueryStringParameter Name="VenueName" QueryStringField="a" />
                        </SelectParameters>
                    </asp:SqlDataSource>
