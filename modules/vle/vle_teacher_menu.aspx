<%@ Page Language="VB" AutoEventWireup="false" CodeFile="vle_teacher_menu.aspx.vb" Inherits="modules_vle_vle_teacher_menu" %>
...
<body topmargin="0" leftmargin="0">
    ...
    <div>
          ...
          <tr>
            <td>
                <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="Small" 
                    Text=":: e-Tutoring Center"></asp:Label></td>
          </tr>
          <tr>
            <td>
              ...
              <tr onmouseover="javascript:ChangeRowBackgroundColor(this);" onmouseout="javascript:RevertRowBackgroundColor(this);">
                <td>
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" 
                        Target="operationFrame">Virtual Classroom</asp:HyperLink>
                  </td>
              </tr>
              <tr onmouseover="javascript:ChangeRowBackgroundColor(this);" onmouseout="javascript:RevertRowBackgroundColor(this);">
              ...
              <tr onmouseover="javascript:ChangeRowBackgroundColor(this);" onmouseout="javascript:RevertRowBackgroundColor(this);">
                <td>
                    <asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="True" 
                        NavigateUrl="" 
                        Target="operationFrame">Practice Questions</asp:HyperLink>
                  </td>
              </tr>
              <tr onmouseover="javascript:ChangeRowBackgroundColor(this);" onmouseout="javascript:RevertRowBackgroundColor(this);">
                <td><hr width="100%" color="black" shading="noshading" /></td>
              ...
              <tr onmouseover="javascript:ChangeRowBackgroundColor(this);" onmouseout="javascript:RevertRowBackgroundColor(this);">
                <td>
                    <asp:HyperLink ID="HyperLink3" runat="server" Font-Bold="True" 
                        ...
                        Target="operationFrame">Discussion Forums</asp:HyperLink>
                  </td>
              </tr>
              <tr onmouseover="javascript:ChangeRowBackgroundColor(this);" onmouseout="javascript:RevertRowBackgroundColor(this);">
                <td><hr width="100%" color="black" shading="noshading" /></td>
            ...
            <table width="100%"  border="0" cellpadding="2" cellspacing="2">
              <tr>
                <td align="left" bgcolor="White" colspan="2">
                    <strong>OpenCourseWare:</strong></td>
              </tr>
              <tr>
      ...
      <option value="http://wikiversity.org/">Wikiversity</option>
                ...
                <tr>
                <td align="left" bgcolor="White" colspan="2">
                    <strong>e-Libraries (Free e-books):</strong></td>
                </tr>
                <tr>
                <td align="left" bgcolor="White">
                    &nbsp;</td>
      ...
      <option value="http://www.worlddigitallibrary.org/">World Digital Library</option>
                ...
                <tr>
                <td align="left" bgcolor="White" colspan="2">
                    <strong>Encyclopedias:</strong></td>
                </tr>
                <tr>
                <td align="left" bgcolor="White">
                    &nbsp;</td>
      ...
      <option value="http://www.wiktionary.org/">Wiktionary.org</option>
                ...
                <tr>
                <td align="left" bgcolor="White" colspan="2">
                    <strong>Leadership Development:</strong></td>
                </tr>
                <tr>
                <td align="left" bgcolor="White">
                    &nbsp;</td>
                ...
                <tr>
                <td align="left" bgcolor="White" colspan="2">
                    <strong>e-Tutoring Aids:</strong></td>
                </tr>
              <tr>
                <td align="left" bgcolor="White">
                    &nbsp;</td>
                ...
                <tr>
                <td align="left" bgcolor="White" colspan="2">
                    <strong>Additional Resources:</strong></td>
                </tr>
                <tr>
                <td align="left" bgcolor="White">
                    &nbsp;</td>
                <td align="left">
                    ...
                    <asp:SqlDataSource ID="dsSqlNewResources" runat="server" 
                        ...
                        <SelectParameters>
                            <asp:Parameter DefaultValue="Teacher" Name="ResourceCategory" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                  </td>
                </tr>
