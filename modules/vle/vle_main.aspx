<%@ Page Language="VB" AutoEventWireup="false" CodeFile="vle_main.aspx.vb" Inherits="modules_vle_vle_main" %>
...
<body topmargin="0" leftmargin="0">
          ...
          <tr>
            <td>
                <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="Small" 
                    Text=":: My Online Learning Aids"></asp:Label></td>
          </tr>
          <tr>
            <td>
  ...
  <tr>
    ...
    <td colspan="2" align="center" valign="middle" class="borderedTableGrey">
                    <a href="http://www.wikibooks.org/" target="operationFrame">
                    <asp:Image ID="Image27" 
                        runat="server" ImageUrl="~/images/Wikibooks.png" 
                        Width="100px" /></a>
                    </td>
    </tr>
  <tr>
    <td align="center" valign="middle" class="borderedTableGrey">&nbsp;</td>
    <td bgcolor='<%= schoolColour %>' colspan="2" align="center" valign="middle" class="borderedTableGrey">
                    <a href="http://www.terasaur.org/" 
                        target="operationFrame">
                    <asp:Image ID="Image16" 
                        runat="server" ImageUrl="~/images/header-logo.png" Width="200px" /></a>
                    </td>
    <td colspan="2" align="center" valign="middle" class="borderedTableGrey">
  ...
  <tr>
    <td colspan="2" align="center" valign="middle" class="borderedTableGrey">
                    <a href="http://www.wikijunior.org/" target="operationFrame">
                    <asp:Image ID="Image23" 
                        runat="server" ImageUrl="~/images/WikiJunior.jpg" 
                        Width="50px" /></a>
                    </td>
    <td colspan="2" align="center" valign="middle" 
          class="borderedTableGrey">
                    <a href="http://www.goorulearning.org/" 
                        target="operationFrame">
                    <asp:Image ID="Image7" 
                        runat="server" ImageUrl="~/images/gooru.png" Height="50px" /></a>
                    </td>
    <td colspan="2" align="center" valign="middle" class="borderedTableGrey">
