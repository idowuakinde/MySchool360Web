...
Partial Class modules_profiles_profile_student
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            className = Common.GetTableRows("SELECT Class FROM VW_StudentProfiles WHERE MatricNumber = " & portalNumber & " ")(0).Item(0).ToString
        ...
        'Response.Write("'" & Common.DecodeHTML(Request.Cookies("Parent")("FatherEmail")) & "', '" & Request.Cookies("Parent")("MotherEmail") & "'") : Response.End()
        dsSqlFamily.SelectParameters("EmailFather").DefaultValue = Common.DecodeHTML(Request.Cookies("Parent")("FatherEmail"))
        dsSqlFamily.SelectParameters("EmailMother").DefaultValue = Common.DecodeHTML(Request.Cookies("Parent")("MotherEmail"))
        dsSqlClassmates.SelectParameters("Class").DefaultValue = className
    End Sub     'Request.Cookies("Parent")("FatherEmail")
